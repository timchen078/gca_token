...
- Previous public email: `redacted-legacy-contact@example.invalid`
...
- Public support/BaseScan files still publish the previous email redacted-legacy-contact@example.invalid after the switch.
