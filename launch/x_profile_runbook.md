...
This runbook records the current official X profile state for GCA and the safe launch-post workflow.
...
Use this after the first public post is visible.
...
Base Mainnet only. No third-party audit. Starter-depth liquidity.
```
