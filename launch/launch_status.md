...
- Public about page prepared at `https://gcagochina.com/about.html` with the company/project profile, Project Operations GCA Team, official contact channels, Base Mainnet identity, product scope, and disclosure boundaries.
...
- Public Chinese member rules page prepared at `https://gcagochina.com/zh-members.html` for 10,000 GCA holder rules, 100 GCA AI Quant Access credits, 1,000,000 GCA / 30-day GCA Member review, and non-live claim boundaries.
...
- BaseScan token update was originally submitted from a non-domain legacy inbox, returned by BaseScan as information-insufficient on 2026-05-13, resubmitted on 2026-05-13, and returned again as information-insufficient on 2026-05-23.
- BaseScan token profile remediation package is ready for owner resubmission; GCA team responsibility evidence, Project Profile BaseScan reviewer map, domain email setup plan, public evidence checklist, activation evidence packet path, and the 2026-05-30 DNS snapshot are now aligned with support@gcagochina.com.
...
- Public BaseScan Handoff copy blocks and Chinese owner submission flow are published at `https://gcagochina.com/basescan-handoff.html` and `https://gcagochina.com/zh-basescan-submit.html`; the Project Profile reviewer map is published at `https://gcagochina.com/project-profile.html#basescanMapTitle`; the next owner action is one clean BaseScan Token Profile update from `support@gcagochina.com`, with GCA Team evidence, the official GCA/USDT route, and no wallet transaction, approve, swap, or contract operation.
...
- Website updated with the GCA AI Quant Access utility thesis: Go China macro narrative plus planned access to non-custodial quant risk reports, backtests, ENTRY_READY review, position sizing, and risk-control education.
- Verified first holder campaign backend documented: each registered user may verify one wallet holding at least 10,000 GCA and receive a one-time 100 GCA AI Quant Access credits ledger record.
- Verified GCA Member backend documented: each registered user may verify one wallet buying and continuously holding at least 1,000,000 GCA for 30 days and qualify for GCA Member status plus one-time 10,000 GCA member benefit review in the GCA Member ledger.
...
- Public roadmap page and JSON prepared at `https://gcagochina.com/roadmap.html` and `https://gcagochina.com/roadmap.json` for concept-stage utility buildout, support intake, member verification, GCA AI Quant Access access planning, external dependencies, and public claim boundaries.
...
- Public privacy notice and participation terms prepared at `https://gcagochina.com/privacy.html`, `https://gcagochina.com/privacy.json`, `https://gcagochina.com/terms.html`, and `https://gcagochina.com/terms.json` for registration data handling, live read-only wallet verification, live eligible ledger records, and staged reviewed service delivery.
...
- Public utility thesis page and access layer spec prepared at `https://gcagochina.com/utility.html` and `https://gcagochina.com/utility.json`.
...
- Public GCA utility credits catalog prepared at `https://gcagochina.com/credits.html` and `https://gcagochina.com/credits.json`; it maps live eligible 100 GCA AI Quant Access credits ledger records and GCA Member workflows to service units.
...
- GeckoTerminal token info update submitted on 2026-05-09 with `support@gcagochina.com`; owner completed OTP verification in the browser and GeckoTerminal confirmed the form was submitted successfully.
...
- Use `https://gcagochina.com/zh-basescan-submit.html` as the Chinese owner checklist and `https://gcagochina.com/basescan-handoff.html` as the copy-block source before opening `https://basescan.org/tokenupdate/`; keep the redacted non-domain legacy inbox only for old thread monitoring, not as the current official project email.
- Include the published GCA team responsibilities URL `https://gcagochina.com/team.html` and the Project Profile BaseScan reviewer map `https://gcagochina.com/project-profile.html#basescanMapTitle`; if BaseScan requests external organization evidence, publish an official organization profile on a recognized business network.
...
- Use `https://gcagochina.com/member-ledger.html` and `https://gcagochina.com/member-ledger.json` when GCA AI Quant Access integration, support review, or community moderators need the published wallet verification and ledger data contract.
...
- Use `https://gcagochina.com/terms.html` before answering questions about participation boundaries, utility credits, GCA Member status, reviewed service delivery, or the no-custody/no-outcome-promise boundary.
...
- Use `https://gcagochina.com/register.html` when a user only wants to join the GCA customer/user list by email without submitting a wallet or requesting member review.
- Use `docs/gca_registration_backend.md` and `cloudflare/gca-registration-worker/` when maintaining the live HTTPS database-backed intake API or preparing the gated service-request and credit-usage routes.
- Use `https://gcagochina.com/zh-members.html` when Chinese users ask what 10,000 GCA holders, 100 GCA AI Quant Access credits, 1,000,000 GCA / 30-day GCA Member review, or the manual 10,000 GCA member benefit review mean.
...
- Use `https://gcagochina.com/product.html` and `https://gcagochina.com/product.json` when reviewers or community members ask how the Go China narrative connects to real product modules; describe the account and eligible ledger path plus browser-only previews as live, while connected service delivery and live trading remain staged.
...
- Use `https://gcagochina.com/access-api.html` and `https://gcagochina.com/access-api.json` when developers, reviewers, or moderators ask which core Workers + D1 routes are live and which service-request / credit-usage routes are still deploy-gated.
...
- Use `https://gcagochina.com/credits.html` and `https://gcagochina.com/credits.json` when reviewers or community members ask what 100 GCA AI Quant Access credits and GCA Member workflows can be used for; eligible ledger records are live, while reviewed service delivery and Worker usage routes remain staged.
...
- Deploy the GCA AI Quant Access GCA intake behind the same official HTTPS origin or a reviewed reverse proxy before enabling the public `Submit Packet` button.
...
- The 10,000 GCA holder bonus must be described as 100 GCA AI Quant Access credits only, not as cash, token claims, income, reimbursement, trading permission, or a way to bypass risk controls.
