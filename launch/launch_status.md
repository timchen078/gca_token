...
- Use `https://gcagochina.com/credits.html` and `https://gcagochina.com/credits.json` when reviewers or community members ask what the planned 100 GCA AI Quant Access credits and GCA Member workflows can be used for; keep it described as a draft service catalog only until controlled account UI and ledgers are live.
