...
- The local operator console now shows the last exported review package mode, `packageDigestSha256`, local verify command, and copyable handoff reply; only `redacted-public` exports are suitable for external reviewer handoff.
