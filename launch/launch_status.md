...
- Include the published Tim Chen professional profile URL `https://gcagochina.com/tim-chen.html` and the Project Profile BaseScan reviewer map `https://gcagochina.com/project-profile.html#basescanMapTitle`; add LinkedIn later only if BaseScan specifically requires a third-party social-network profile.
