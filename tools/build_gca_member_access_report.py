...
def build_report(payload: dict[str, Any], output_dir: Path, summary_output: Path) -> dict[str, Any]:
    ...
    summary = {
        ...
        "counts": {
            ...
            "serviceRequestsPendingReview": count_any(
                service_requests,
                "status",
                {
            ...
            "serviceRequestsExpiredCreditLedger": count_records(service_requests, "status", "queued_expired_credit_ledger"),
            "serviceRequestsAwaitingMemberFollowup": count_records(service_requests, "status", "needs_more_information"),
            "serviceRequestsAwaitingDelivery": count_records(service_requests, "status", "approved_operator_review"),
            "deliveredServiceRequests": count_records(service_requests, "status", "delivered"),
            "rejectedServiceRequests": count_records(service_requests, "status", "rejected_operator_review"),
            "cancelledServiceRequests": count_records(service_requests, "status", "cancelled_by_account"),
