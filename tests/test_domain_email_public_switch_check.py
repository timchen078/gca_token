...
class DomainEmailPublicSwitchCheckTests(unittest.TestCase):
    def test_current_repo_reports_public_switch_pending(self):
        ...
        self.assertIn("current-email-still-published", report["blockedRequirements"])
        self.assertGreater(report["summary"]["filesStillUsingCurrentEmail"], 0)
    ...
    def test_markdown_is_copyable_and_explicit(self):
        ...
        self.assertIn("Ready for BaseScan public email alignment: `false`", markdown)
