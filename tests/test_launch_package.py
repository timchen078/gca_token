...
class LaunchPackageTests(unittest.TestCase):
    ...
    def test_service_delivery_playbook_publishes_operator_reviewed_workflow(self):
        ...
        self.assertEqual(playbook["routeStatus"]["latestPublicRouteCheckAt"], "2026-07-27T09:37:54Z")
        ...
        self.assertEqual(playbook["routeStatus"]["workerVersionId"], "510315f5-8db3-4e08-b574-6e14b618aed5")
    ...
    def test_worker_routes_handoff_publishes_production_route_deploy_record(self):
        ...
        self.assertEqual(handoff["currentStatus"]["latestPublicRouteCheckAt"], "2026-07-27T09:37:54Z")
        self.assertEqual(handoff["currentStatus"]["latestAdminRouteCheckAt"], "2026-07-27T09:38:07Z")
    ...
    def test_member_ledger_page_and_json_define_public_schema(self):
        ...
        self.assertEqual(ledger["status"], "public-member-ledger-benefit-evidence-live")
    ...
    def test_access_api_page_and_json_define_live_member_access_routes(self):
        ...
        for forbidden in (
            ...
            self.assertNotIn(forbidden, page)
        self.assertIn("member benefit evidence API live", page)
        ...
        self.assertEqual(api["status"], "public-access-api-member-benefit-evidence-live")
        self.assertEqual(api["chainId"], 8453)
        self.assertEqual(api["contractAddress"], MAINNET_ADDRESS)
        self.assertEqual(api["currentState"]["currentStage"], "member-benefit-transfer-evidence-api-live")
    ...
    def test_access_operations_page_and_json_define_manual_operations_runbook(self):
        ...
        for forbidden in (
            ...
            self.assertNotIn(forbidden, page)
        self.assertIn("member-benefit evidence operations live", page)
        self.assertIn("account intake", page)
        ...
        self.assertEqual(ops["status"], "public-access-operations-member-benefit-evidence-live")
        self.assertEqual(ops["chainId"], 8453)
        self.assertEqual(ops["contractAddress"], MAINNET_ADDRESS)
        self.assertEqual(ops["currentState"]["currentStage"], "member-benefit-transfer-evidence-operations-live")
        ...
        self.assertEqual(ops["currentState"]["memberBenefitTransferProductionVerifiedAt"], "2026-07-27T09:38:07Z")
        ...
        self.assertEqual(ops["currentState"]["memberReviewProductionVerifiedAt"], "2026-07-27T09:38:07Z")
    ...
    def test_release_gates_page_and_json_define_go_live_boundaries(self):
        ...
        self.assertIn("Public account UI, wallet verification, eligible 100-credit records, protected member decisions, observed 30-day holding-history verification, and production evidence for already-completed manual member-benefit transfers are live", page)
        self.assertIn("Live at /gca/member-access/", page)
        ...
        self.assertEqual(gates["status"], "public-release-gates-member-benefit-evidence-live")
        ...
        self.assertEqual(gates["currentState"]["currentStage"], "member-benefit-transfer-evidence-path-live")
        ...
        self.assertEqual(gates["currentState"]["memberBenefitTransferProductionVerifiedAt"], "2026-07-27T09:38:07Z")
        ...
        self.assertEqual(gates["currentState"]["latestPendingRoutePublicCheckAt"], "2026-07-27T09:37:54Z")
        self.assertEqual(gates["currentState"]["latestPendingRouteAdminCheckAt"], "2026-07-27T09:38:07Z")
        ...
        self.assertEqual(gates["currentState"]["workerVersionId"], "510315f5-8db3-4e08-b574-6e14b618aed5")
