...
class LaunchPackageTests(unittest.TestCase):
    ...
    def test_access_api_page_and_json_define_contract_only_backend_routes(self):
        ...
        self.assertFalse(api["currentState"]["productionEmailRegistrationApiLive"])
        ...
        self.assertEqual(api["productionEmailRegistrationBackend"]["submissionEndpoint"], "https://api.gcagochina.com/gca/email-registrations")
        self.assertEqual(api["productionEmailRegistrationBackend"]["publicWebsiteFallback"], "official-email-fallback")
        self.assertTrue(api["productionEmailRegistrationBackend"]["requiresCloudflareAccountDeployment"])
        self.assertTrue(api["productionEmailRegistrationBackend"]["requiresD1DatabaseId"])
    ...
    def test_cloudflare_registration_backend_is_deployable_and_safe(self):
        ...
        self.assertIn("REPLACE_WITH_CLOUDFLARE_D1_DATABASE_ID", wrangler)
        ...
        self.assertIn("https://api.gcagochina.com/gca/email-registrations", docs)
        self.assertIn("npx wrangler d1 migrations apply gca_registration --remote", docs)
        self.assertIn("https://api.gcagochina.com", register_page)
