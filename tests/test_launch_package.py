...
class LaunchPackageTests(unittest.TestCase):
    ...
    def test_zh_basescan_submit_page_guides_owner_without_json_links(self):
        ...
        self.assertIn("team.html#tim-chen", page)
        self.assertIn("官网、白皮书、品牌资料、支持页、GitHub、Telegram、X、GCA/USDT 池", page)
    ...
    def test_listing_readiness_page_gates_tracked_listing_submissions(self):
        ...
        self.assertIn("Tim Chen profile, domain email plan, evidence checklist, activation evidence packet, BaseScan Handoff, Chinese owner flow, and support@gcagochina.com evidence are ready", page)
    ...
    def test_external_reviews_page_and_json_centralize_review_status(self):
        ...
        self.assertIn("Tim Chen profile, domain email plan, evidence checklist, activation evidence packet, reply template, BaseScan Handoff copy blocks, Chinese owner flow, and support@gcagochina.com evidence are ready", page)
