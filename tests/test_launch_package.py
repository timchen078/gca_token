...
class LaunchPackageTests(unittest.TestCase):
    ...
    def test_daily_status_page_and_json_publish_public_ops_snapshot(self):
        ...
        self.assertEqual(daily_steps["official-pool-market-health"]["command"], "python3 tools/check_gca_market_health.py --json --timeout 20")
    ...
    def test_basescan_remediation_page_and_json_track_return_notice(self):
        ...
        self.assertIn("2026-08-11T19:25:21Z", page)
        ...
        self.assertEqual(checklist_builder["dailyStatusGeneratedAt"], "2026-08-11T19:25:21Z")
    ...
    def test_basescan_reviewer_checklist_artifacts_are_current_and_blocked(self):
        ...
        self.assertEqual(data["dailyStatusGeneratedAt"], "2026-08-11T19:25:21Z")
    ...
    def test_basescan_preflight_page_and_json_gate_next_resubmission(self):
        ...
        self.assertEqual(data["preflightRefresh"]["dailyStatusSnapshotRefreshedAt"], "2026-08-11T19:25:21Z")
    ...
    def test_basescan_followup_page_and_json_prepare_no_reply_ticket_reply(self):
        ...
        self.assertIn("2026-08-11T19:25:21Z", data["followupTemplate"]["body"])
        self.assertIn("avoid duplicate token-profile submissions", data["followupTemplate"]["body"])
        self.assertEqual(data["latestPublicEvidence"]["snapshotGeneratedAt"], "2026-08-11T19:25:21Z")
    ...
    def test_privacy_and_terms_pages_define_pre_registration_boundaries(self):
        ...
        self.assertIn("Final package 2026-08-11T18:56:43Z; daily status 2026-08-11T19:25:21Z", terms_page)
    ...
    def test_roadmap_page_and_json_define_buildout_boundaries(self):
        ...
        self.assertIn("Final package 2026-08-11T18:56:43Z; daily status 2026-08-11T19:25:21Z", page)
    ...
    def test_release_gates_page_and_json_define_go_live_boundaries(self):
        ...
        self.assertEqual(gates["currentState"]["baseScanTokenProfileLastCheckedDate"], "2026-08-11")
        self.assertEqual(gates["currentState"]["baseScanFinalSubmissionPackageGeneratedAt"], "2026-08-11T18:56:43Z")
        self.assertEqual(gates["currentState"]["dailyStatusGeneratedAt"], "2026-08-11T19:25:21Z")
        ...
        self.assertEqual(base_scan_gate["dailyStatusGeneratedAt"], "2026-08-11T19:25:21Z")
        ...
        self.assertIn("The latest BaseScan owner submission package was generated on 2026-08-11T18:56:43Z, and the daily public status snapshot was refreshed on 2026-08-11T19:25:21Z.", gates["publicClaimBoundaries"]["safeClaims"])
    ...
    def test_verify_page_centralizes_official_identity_and_status(self):
        ...
        self.assertIn("Returned 2026-05-23; final package refreshed 2026-08-11; Handoff and Chinese owner flow ready for one support@gcagochina.com submission", verify)
        self.assertIn("Latest reviewer package", verify)
        self.assertIn("Final package 2026-08-11T18:56:43Z; daily status 2026-08-11T19:25:21Z", verify)
    ...
    def test_chinese_wallet_verify_reuses_live_contract_identity(self):
        ...
        self.assertIn("只读钱包验证 / 2026-08-11", page)
        self.assertIn("链上实时核验", page)
        self.assertIn("GCA 合约身份", page)
        ...
        self.assertIn("这一项核验合约身份，不读取个人钱包余额", page)
        self.assertIn("不会连接钱包、申请权限、请求签名或发送交易", page)
        self.assertIn("Base 公共 RPC 有频率限制", page)
        self.assertIn("官方 BaseScan 合约页", page)
        self.assertIn(MAINNET_ADDRESS, page)
    ...
    def test_listing_readiness_page_gates_tracked_listing_submissions(self):
        ...
        self.assertIn("Snapshot refreshed 2026-08-11T19:25:21Z", page)
    ...
    def test_listing_kit_and_project_json_are_copyable(self):
        ...
        self.assertEqual(project["baseScanHandoff"]["dailyStatusGeneratedAt"], "2026-08-11T19:25:21Z")
        ...
        self.assertEqual(project["platformStatus"]["baseScanTokenProfileLastCheckedDate"], "2026-08-11")
        self.assertIn("Read-only public BaseScan check on 2026-08-11", project["platformStatus"]["baseScanTokenProfileLastCheckedResult"])
        ...
        self.assertIn("2026-08-11T19:25:21Z", project["platformStatus"]["baseScanTokenProfileLastCheckedResult"])
        ...
        self.assertEqual(project["platformStatus"]["dailyStatusGeneratedAt"], "2026-08-11T19:25:21Z")
        ...
        self.assertEqual(project["externalReviewStatus"]["baseScanTokenProfileLastCheckedDate"], "2026-08-11")
        self.assertIn("2026-08-11T18:56:43Z", project["externalReviewStatus"]["baseScanTokenProfileLastCheckedResult"])
        self.assertIn("2026-08-11T19:25:21Z", project["externalReviewStatus"]["baseScanTokenProfileLastCheckedResult"])
        ...
        self.assertEqual(project["externalReviewStatus"]["dailyStatusGeneratedAt"], "2026-08-11T19:25:21Z")
    ...
    def test_listing_readiness_json_gates_tracked_listing_submissions(self):
        ...
        self.assertEqual(checks["basescan-token-profile"]["lastCheckedDate"], "2026-08-11")
        self.assertEqual(checks["basescan-token-profile"]["finalSubmissionPackageGeneratedAt"], "2026-08-11T18:56:43Z")
        self.assertEqual(checks["basescan-token-profile"]["dailyStatusGeneratedAt"], "2026-08-11T19:25:21Z")
        self.assertIn("Read-only public BaseScan check on 2026-08-11", checks["basescan-token-profile"]["evidence"])
        ...
        self.assertIn("2026-08-11T19:25:21Z", checks["basescan-token-profile"]["evidence"])
    ...
    def test_external_reviews_page_and_json_centralize_review_status(self):
        ...
        self.assertIn("Read-only check 2026-08-11 still shows", page)
        ...
        self.assertEqual(reviews["reviews"]["baseScanTokenProfile"]["lastCheckedDate"], "2026-08-11")
        self.assertIn("Read-only public BaseScan check on 2026-08-11", reviews["reviews"]["baseScanTokenProfile"]["lastCheckedResult"])
        ...
        self.assertIn("2026-08-11T19:25:21Z", reviews["reviews"]["baseScanTokenProfile"]["lastCheckedResult"])
    ...
    def test_reviewer_kit_page_and_json_centralize_reviewer_evidence(self):
        ...
        self.assertIn("Latest reviewer package", page)
        self.assertIn("Final package generated 2026-08-11T18:56:43Z; daily status refreshed 2026-08-11T19:25:21Z", page)
        ...
        self.assertEqual(kit["externalReviewStatus"]["baseScanTokenProfileLastCheckedDate"], "2026-08-11")
        self.assertEqual(kit["externalReviewStatus"]["baseScanFinalSubmissionPackageGeneratedAt"], "2026-08-11T18:56:43Z")
        self.assertEqual(kit["externalReviewStatus"]["dailyStatusGeneratedAt"], "2026-08-11T19:25:21Z")
        ...
        self.assertEqual(kit["baseScanResubmissionHandoff"]["dailyStatusGeneratedAt"], "2026-08-11T19:25:21Z")
        ...
        self.assertIn("2026-08-11T19:25:21Z", " ".join(kit["reviewerUse"]["nextActions"]))
    ...
    def test_trust_center_page_and_json_centralize_public_verification(self):
        ...
        self.assertEqual(trust["verificationSnapshot"]["baseScanTokenProfileLastCheckedDate"], "2026-08-11")
        self.assertEqual(trust["verificationSnapshot"]["baseScanFinalSubmissionPackageGeneratedAt"], "2026-08-11T18:56:43Z")
        self.assertEqual(trust["verificationSnapshot"]["dailyStatusGeneratedAt"], "2026-08-11T19:25:21Z")
        ...
        self.assertEqual(trust["externalReviewStatus"]["baseScanTokenProfileLastCheckedDate"], "2026-08-11")
        self.assertEqual(trust["externalReviewStatus"]["baseScanFinalSubmissionPackageGeneratedAt"], "2026-08-11T18:56:43Z")
        self.assertEqual(trust["externalReviewStatus"]["dailyStatusGeneratedAt"], "2026-08-11T19:25:21Z")
        ...
        self.assertIn("The latest BaseScan owner submission package was generated on 2026-08-11T18:56:43Z, and the daily public status snapshot was refreshed on 2026-08-11T19:25:21Z.", trust["safePublicClaims"])
    ...
    def test_basescan_review_followup_is_actionable(self):
        ...
        self.assertIn("2026-08-11T19:25:21Z", followup)
    ...
    def test_basescan_form_values_are_copyable(self):
        ...
        self.assertEqual(values["lastCheckedDate"], "2026-08-11")
        self.assertIn("Read-only public BaseScan check on 2026-08-11", values["lastCheckedResult"])
        ...
        self.assertIn("2026-08-11T19:25:21Z", values["lastCheckedResult"])
        ...
        self.assertEqual(values["dailyStatusGeneratedAt"], "2026-08-11T19:25:21Z")
    ...
    def test_external_review_followup_tracker_is_actionable_and_conservative(self):
        ...
        self.assertEqual(values["platforms"]["baseScan"]["lastCheckedDate"], "2026-08-11")
        ...
        self.assertIn("2026-08-11T19:25:21Z", values["platforms"]["baseScan"]["lastCheckedResult"])
