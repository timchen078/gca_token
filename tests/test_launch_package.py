...
class LaunchPackageTests(unittest.TestCase):
    ...
    def test_basescan_handoff_page_and_json_index_resubmission_evidence(self):
        ...
        self.assertIn("2026-06-05T11:01:28Z", page)
        ...
        self.assertEqual(data["finalSubmissionPackage"]["generatedAt"], "2026-06-05T11:01:28Z")
    ...
    def test_privacy_and_terms_pages_define_pre_registration_boundaries(self):
        ...
        self.assertIn("Returned 2026-05-23; final package refreshed 2026-06-05; Handoff and Chinese owner flow ready for one support@gcagochina.com submission", terms_page)
        self.assertIn("Latest reviewer package", terms_page)
        self.assertIn("Final package 2026-06-05T11:01:28Z; daily status 2026-06-06T11:02:01Z", terms_page)
    ...
    def test_roadmap_page_and_json_define_buildout_boundaries(self):
        ...
        self.assertIn("Returned 2026-05-23; final package refreshed 2026-06-05; Handoff and Chinese owner flow ready for one support@gcagochina.com submission", page)
        self.assertIn("Latest reviewer package", page)
        self.assertIn("Final package 2026-06-05T11:01:28Z; daily status 2026-06-06T11:02:01Z", page)
    ...
    def test_release_gates_page_and_json_define_go_live_boundaries(self):
        ...
        self.assertEqual(gates["currentState"]["baseScanFinalSubmissionPackageGeneratedAt"], "2026-06-05T11:01:28Z")
        ...
        self.assertEqual(base_scan_gate["finalSubmissionPackageGeneratedAt"], "2026-06-05T11:01:28Z")
        ...
        self.assertIn("The latest BaseScan owner submission package was generated on 2026-06-05T11:01:28Z, and the daily public status snapshot was refreshed on 2026-06-06T11:02:01Z.", gates["publicClaimBoundaries"]["safeClaims"])
    ...
    def test_verify_page_centralizes_official_identity_and_status(self):
        ...
        self.assertIn("Returned 2026-05-23; final package refreshed 2026-06-05; Handoff and Chinese owner flow ready for one support@gcagochina.com submission", verify)
        self.assertIn("Latest reviewer package", verify)
        self.assertIn("Final package 2026-06-05T11:01:28Z; daily status 2026-06-06T11:02:01Z", verify)
    ...
    def test_listing_readiness_page_gates_tracked_listing_submissions(self):
        ...
        self.assertIn("Returned again 2026-05-23; final package refreshed 2026-06-05; Handoff and Chinese owner flow ready for one support@gcagochina.com submission", page)
        ...
        self.assertIn("Final submission package generated 2026-06-05T11:01:28Z", page)
        self.assertIn("Domain Email Evidence Checklist", page)
        self.assertIn("domain-email-evidence.html", page)
    ...
    def test_listing_kit_and_project_json_are_copyable(self):
        ...
        self.assertEqual(project["baseScanHandoff"]["finalSubmissionPackageGeneratedAt"], "2026-06-05T11:01:28Z")
        ...
        self.assertIn("2026-06-05T11:01:28Z", project["platformStatus"]["baseScanTokenProfileLastCheckedResult"])
        self.assertIn("2026-06-06T11:02:01Z", project["platformStatus"]["baseScanTokenProfileLastCheckedResult"])
        self.assertEqual(project["platformStatus"]["baseScanFinalSubmissionPackageGeneratedAt"], "2026-06-05T11:01:28Z")
        ...
        self.assertIn("2026-06-05T11:01:28Z", project["externalReviewStatus"]["baseScanTokenProfileLastCheckedResult"])
        ...
        self.assertEqual(project["externalReviewStatus"]["baseScanFinalSubmissionPackageGeneratedAt"], "2026-06-05T11:01:28Z")
    ...
    def test_listing_readiness_json_gates_tracked_listing_submissions(self):
        ...
        self.assertEqual(checks["basescan-token-profile"]["finalSubmissionPackageGeneratedAt"], "2026-06-05T11:01:28Z")
        ...
        self.assertIn("2026-06-05T11:01:28Z", checks["basescan-token-profile"]["evidence"])
    ...
    def test_external_reviews_page_and_json_centralize_review_status(self):
        ...
        self.assertIn("final package refreshed 2026-06-05", page)
        self.assertIn("2026-06-05T11:01:28Z", page)
        ...
        self.assertIn("2026-06-05T11:01:28Z", reviews["reviews"]["baseScanTokenProfile"]["lastCheckedResult"])
        ...
        self.assertIn("The latest BaseScan final submission package was generated on 2026-06-05T11:01:28Z, and the daily public status snapshot confirms readyForBaseScanResubmission is true.", reviews["safePublicClaims"])
    ...
    def test_reviewer_kit_page_and_json_centralize_reviewer_evidence(self):
        ...
        self.assertIn("Latest reviewer package", page)
        self.assertIn("Final package generated 2026-06-05T11:01:28Z; daily status refreshed 2026-06-06T11:02:01Z", page)
        ...
        self.assertEqual(kit["externalReviewStatus"]["baseScanFinalSubmissionPackageGeneratedAt"], "2026-06-05T11:01:28Z")
        ...
        self.assertEqual(kit["baseScanResubmissionHandoff"]["finalSubmissionPackageGeneratedAt"], "2026-06-05T11:01:28Z")
        ...
        self.assertIn("2026-06-05T11:01:28Z", " ".join(kit["reviewerUse"]["nextActions"]))
    ...
    def test_trust_center_page_and_json_centralize_public_verification(self):
        ...
        self.assertEqual(trust["verificationSnapshot"]["baseScanFinalSubmissionPackageGeneratedAt"], "2026-06-05T11:01:28Z")
        ...
        self.assertEqual(trust["externalReviewStatus"]["baseScanFinalSubmissionPackageGeneratedAt"], "2026-06-05T11:01:28Z")
        ...
        self.assertIn("The latest BaseScan owner submission package was generated on 2026-06-05T11:01:28Z, and the daily public status snapshot was refreshed on 2026-06-06T11:02:01Z.", trust["safePublicClaims"])
    ...
    def test_basescan_form_values_are_copyable(self):
        ...
        self.assertIn("2026-06-05T11:01:28Z", values["lastCheckedResult"])
        ...
        self.assertEqual(values["baseScanFinalSubmissionPackageGeneratedAt"], "2026-06-05T11:01:28Z")
    ...
    def test_external_review_followup_tracker_is_actionable_and_conservative(self):
        ...
        self.assertIn("2026-06-05T11:01:28Z", values["platforms"]["baseScan"]["lastCheckedResult"])
