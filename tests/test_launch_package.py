...
class LaunchPackageTests(unittest.TestCase):
    ...
    def test_public_site_discloses_current_operational_status(self):
        ...
        self.assertIn("Public team and Tim Chen professional profile evidence are now published", site)
    ...
    def test_community_page_and_json_define_safe_public_messaging(self):
        ...
        self.assertIn("Tim Chen public professional profile evidence and the domain email setup plan are now published", community["xLaunchPack"]["currentStatusAfterLatestPost"])
    ...
    def test_announcements_page_and_json_track_official_content_cadence(self):
        ...
        self.assertIn("domain email setup plan are now published", page)
        ...
        self.assertIn("Tim Chen public professional profile evidence and the domain email setup plan are now published", latest_post["currentStatusAfterPost"])
