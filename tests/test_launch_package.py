...
class LaunchPackageTests(unittest.TestCase):
    ...
    def test_roadmap_page_and_json_define_buildout_boundaries(self):
        ...
        self.assertEqual(roadmap["externalDependencies"]["baseScanTokenProfile"], "submitted-awaiting-review")
    ...
    def test_community_page_and_json_define_safe_public_messaging(self):
        ...
        self.assertTrue(any("BaseScan token profile is still awaiting review" in item for item in community["safeAnnouncement"]))
