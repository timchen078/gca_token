...
class LaunchPackageTests(unittest.TestCase):
    ...
    def test_domain_email_setup_page_and_json_gate_basescan_resubmission(self):
        ...
        self.assertIn("no longer publish GCAgochina@outlook.com", public_switch_checker["purpose"])
        ...
        self.assertIn("any critical file still contains GCAgochina@outlook.com", public_switch_checker["blocksWhen"])
        ...
        self.assertEqual(current_switch["currentEmail"], "GCAgochina@outlook.com")
    ...
    def test_basescan_handoff_page_and_json_index_resubmission_evidence(self):
        ...
        self.assertIn("2026-06-04T08:49:54Z", page)
        ...
        self.assertEqual(data["finalSubmissionPackage"]["generatedAt"], "2026-06-04T08:49:54Z")
    ...
    def test_privacy_and_terms_pages_define_pre_registration_boundaries(self):
        ...
        self.assertIn("Returned 2026-05-23; final package refreshed 2026-06-04; Handoff and Chinese owner flow ready for one support@gcagochina.com submission", terms_page)
        self.assertIn("Latest reviewer package", terms_page)
        self.assertIn("Final package 2026-06-04T08:49:54Z; daily status 2026-06-04T08:59:57Z", terms_page)
    ...
    def test_roadmap_page_and_json_define_buildout_boundaries(self):
        ...
        self.assertIn("Returned 2026-05-23; final package refreshed 2026-06-04; Handoff and Chinese owner flow ready for one support@gcagochina.com submission", page)
        self.assertIn("Latest reviewer package", page)
        self.assertIn("Final package 2026-06-04T08:49:54Z; daily status 2026-06-04T08:59:57Z", page)
    ...
    def test_member_ledger_page_and_json_define_public_schema(self):
        ...
        self.assertIn("eligible 10,000 GCA holders can create one account-level 100 Web3 Radar utility credits ledger record", page)
        self.assertNotIn(OLD_WETH_POOL_ADDRESS, page)
        self.assertNotIn("GCA/WETH", page)
    ...
    def test_credits_catalog_page_and_json_define_draft_service_units(self):
        ...
        self.assertIn("GCA has published a service catalog for Web3 Radar utility credits.", credits["publicClaimBoundaries"]["safeClaims"])
    ...
    def test_release_gates_page_and_json_define_go_live_boundaries(self):
        ...
        self.assertEqual(gates["currentState"]["baseScanFinalSubmissionPackageGeneratedAt"], "2026-06-04T08:49:54Z")
        self.assertEqual(gates["currentState"]["dailyStatusGeneratedAt"], "2026-06-04T08:59:57Z")
        ...
        self.assertEqual(base_scan_gate["finalSubmissionPackageGeneratedAt"], "2026-06-04T08:49:54Z")
        self.assertEqual(base_scan_gate["dailyStatusGeneratedAt"], "2026-06-04T08:59:57Z")
        ...
        self.assertIn("The latest BaseScan owner submission package was generated on 2026-06-04T08:49:54Z, and the daily public status snapshot was refreshed on 2026-06-04T08:59:57Z.", gates["publicClaimBoundaries"]["safeClaims"])
    ...
    def test_verify_page_centralizes_official_identity_and_status(self):
        ...
        self.assertIn("Returned 2026-05-23; final package refreshed 2026-06-04; Handoff and Chinese owner flow ready for one support@gcagochina.com submission", verify)
        self.assertIn("Latest reviewer package", verify)
        self.assertIn("Final package 2026-06-04T08:49:54Z; daily status 2026-06-04T08:59:57Z", verify)
    ...
    def test_listing_readiness_page_gates_tracked_listing_submissions(self):
        ...
        self.assertIn("Returned again 2026-05-23; final package refreshed 2026-06-04; Handoff and Chinese owner flow ready for one support@gcagochina.com submission", page)
        ...
        self.assertIn("Snapshot refreshed 2026-06-04T08:59:57Z", page)
        self.assertIn("Final submission package generated 2026-06-04T08:49:54Z", page)
        self.assertIn("Domain Email Evidence Checklist", page)
        self.assertIn("domain-email-evidence.html", page)
    ...
    def test_listing_kit_and_project_json_are_copyable(self):
        ...
        self.assertEqual(project["baseScanHandoff"]["finalSubmissionPackageGeneratedAt"], "2026-06-04T08:49:54Z")
        self.assertEqual(project["baseScanHandoff"]["dailyStatusGeneratedAt"], "2026-06-04T08:59:57Z")
        ...
        self.assertIn("2026-06-04T08:49:54Z", project["platformStatus"]["baseScanTokenProfileLastCheckedResult"])
        self.assertIn("2026-06-04T08:59:57Z", project["platformStatus"]["baseScanTokenProfileLastCheckedResult"])
        self.assertEqual(project["platformStatus"]["baseScanFinalSubmissionPackageGeneratedAt"], "2026-06-04T08:49:54Z")
        ...
        self.assertEqual(project["platformStatus"]["dailyStatusGeneratedAt"], "2026-06-04T08:59:57Z")
        ...
        self.assertIn("2026-06-04T08:49:54Z", project["externalReviewStatus"]["baseScanTokenProfileLastCheckedResult"])
        self.assertIn("2026-06-04T08:59:57Z", project["externalReviewStatus"]["baseScanTokenProfileLastCheckedResult"])
        ...
        self.assertEqual(project["externalReviewStatus"]["baseScanFinalSubmissionPackageGeneratedAt"], "2026-06-04T08:49:54Z")
        self.assertEqual(project["externalReviewStatus"]["dailyStatusGeneratedAt"], "2026-06-04T08:59:57Z")
    ...
    def test_listing_readiness_json_gates_tracked_listing_submissions(self):
        ...
        self.assertEqual(checks["basescan-token-profile"]["finalSubmissionPackageGeneratedAt"], "2026-06-04T08:49:54Z")
        self.assertEqual(checks["basescan-token-profile"]["dailyStatusGeneratedAt"], "2026-06-04T08:59:57Z")
        ...
        self.assertIn("2026-06-04T08:49:54Z", checks["basescan-token-profile"]["evidence"])
        self.assertIn("2026-06-04T08:59:57Z", checks["basescan-token-profile"]["evidence"])
    ...
    def test_external_reviews_page_and_json_centralize_review_status(self):
        ...
        self.assertIn("final package refreshed 2026-06-04", page)
        self.assertIn("2026-06-04T08:49:54Z", page)
        self.assertIn("2026-06-04T08:59:57Z", page)
        self.assertIn(TIM_CHEN_PROFILE_PAGE_URL, page)
        ...
        self.assertIn("2026-06-04T08:49:54Z", reviews["reviews"]["baseScanTokenProfile"]["lastCheckedResult"])
        self.assertIn("2026-06-04T08:59:57Z", reviews["reviews"]["baseScanTokenProfile"]["lastCheckedResult"])
        ...
        self.assertIn("The latest BaseScan final submission package was generated on 2026-06-04T08:49:54Z, and the daily public status snapshot confirms readyForBaseScanResubmission is true.", reviews["safePublicClaims"])
    ...
    def test_reviewer_kit_page_and_json_centralize_reviewer_evidence(self):
        ...
        self.assertIn("Latest reviewer package", page)
        self.assertIn("Final package generated 2026-06-04T08:49:54Z; daily status refreshed 2026-06-04T08:59:57Z", page)
        ...
        self.assertEqual(kit["externalReviewStatus"]["baseScanFinalSubmissionPackageGeneratedAt"], "2026-06-04T08:49:54Z")
        self.assertEqual(kit["externalReviewStatus"]["dailyStatusGeneratedAt"], "2026-06-04T08:59:57Z")
        ...
        self.assertEqual(kit["baseScanResubmissionHandoff"]["finalSubmissionPackageGeneratedAt"], "2026-06-04T08:49:54Z")
        self.assertEqual(kit["baseScanResubmissionHandoff"]["dailyStatusGeneratedAt"], "2026-06-04T08:59:57Z")
        ...
        self.assertIn("2026-06-04T08:49:54Z", " ".join(kit["reviewerUse"]["nextActions"]))
        self.assertIn("2026-06-04T08:59:57Z", " ".join(kit["reviewerUse"]["nextActions"]))
    ...
    def test_trust_center_page_and_json_centralize_public_verification(self):
        ...
        self.assertEqual(trust["verificationSnapshot"]["baseScanFinalSubmissionPackageGeneratedAt"], "2026-06-04T08:49:54Z")
        self.assertEqual(trust["verificationSnapshot"]["dailyStatusGeneratedAt"], "2026-06-04T08:59:57Z")
        ...
        self.assertEqual(trust["externalReviewStatus"]["baseScanFinalSubmissionPackageGeneratedAt"], "2026-06-04T08:49:54Z")
        self.assertEqual(trust["externalReviewStatus"]["dailyStatusGeneratedAt"], "2026-06-04T08:59:57Z")
        ...
        self.assertIn("The latest BaseScan owner submission package was generated on 2026-06-04T08:49:54Z, and the daily public status snapshot was refreshed on 2026-06-04T08:59:57Z.", trust["safePublicClaims"])
    ...
    def test_external_review_followup_tracker_is_actionable_and_conservative(self):
        ...
        self.assertIn("2026-06-04T08:49:54Z", values["platforms"]["baseScan"]["lastCheckedResult"])
        self.assertIn("2026-06-04T08:59:57Z", values["platforms"]["baseScan"]["lastCheckedResult"])
