...
class LaunchPackageTests(unittest.TestCase):
    ...
    def test_privacy_and_terms_pages_define_pre_registration_boundaries(self):
        ...
        self.assertIn("Returned 2026-05-23; Handoff and Chinese owner flow ready for one support@gcagochina.com submission", terms_page)
    ...
    def test_roadmap_page_and_json_define_buildout_boundaries(self):
        ...
        self.assertIn("Returned 2026-05-23; Handoff and Chinese owner flow ready for one support@gcagochina.com submission", page)
    ...
    def test_verify_page_centralizes_official_identity_and_status(self):
        ...
        self.assertIn("Returned 2026-05-23; Handoff and Chinese owner flow ready for one support@gcagochina.com submission", verify)
