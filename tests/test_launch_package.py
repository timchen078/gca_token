...
class LaunchPackageTests(unittest.TestCase):
    ...
    def test_team_page_publishes_founder_profile_for_reviewers(self):
        ...
        self.assertIn("does not fabricate an external profile", page)
    ...
    def test_basescan_remediation_page_and_json_track_return_notice(self):
        ...
        self.assertIn("No. Fix domain email and external professional profile evidence first.", page)
    ...
    def test_public_site_discloses_current_operational_status(self):
        ...
        self.assertIn("project-domain email, and external professional profile evidence are ready", site)
    ...
    def test_status_page_centralizes_public_verification(self):
        ...
        self.assertIn("fix domain email and public professional profile evidence before resubmission", status)
    ...
    def test_listing_kit_and_project_json_are_copyable(self):
        ...
        self.assertIn("project-domain email and public professional profile evidence are ready", kit)
    ...
    def test_listing_readiness_json_gates_tracked_listing_submissions(self):
        ...
        self.assertIn("Create and publish a working gcagochina.com domain email before the next BaseScan submission.", readiness["nextActions"])
        self.assertIn("Publish a Tim Chen LinkedIn or equivalent external professional profile, or prepare a clear explanation of official-domain team page and GitHub evidence.", readiness["nextActions"])
    ...
    def test_external_reviews_page_and_json_centralize_review_status(self):
        ...
        self.assertIn("Returned 2026-05-23; remediation required", page)
        self.assertIn("fix domain email and public professional profile evidence before resubmission", page)
        self.assertIn("Owner observed no warning visible 2026-05-14", page)
        self.assertIn("Approved 2026-05-11", page)
        self.assertIn("Trust Center", page)
        self.assertIn("Blockaid Follow-up", page)
    ...
    def test_external_review_followup_tracker_is_actionable_and_conservative(self):
        ...
        self.assertIn("Publish a Tim Chen LinkedIn or equivalent external professional profile", tracker)
    ...
    def test_site_has_whitepaper_page(self):
        ...
        self.assertIn("project-domain email and public professional profile evidence are ready", whitepaper)
