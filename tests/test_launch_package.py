...
class LaunchPackageTests(unittest.TestCase):
    ...
    def test_listing_readiness_page_gates_tracked_listing_submissions(self):
        ...
        self.assertIn("Returned again 2026-05-23; Handoff and Chinese owner flow ready for one support@gcagochina.com submission", page)
    ...
    def test_listing_readiness_json_gates_tracked_listing_submissions(self):
        ...
        self.assertEqual(checks["basescan-token-profile"]["lastCheckedDate"], "2026-05-30")
        ...
        self.assertIn("domain email setup plan, public evidence checklist, and activation evidence packet are published", checks["basescan-token-profile"]["evidence"])
