...
class LaunchPackageTests(unittest.TestCase):
    ...
    def test_external_reviews_page_and_json_centralize_review_status(self):
        ...
        self.assertEqual(reviews["lastUpdated"], "2026-06-02")
        ...
        self.assertEqual(reviews["reviews"]["baseScanTokenProfile"]["lastCheckedDate"], "2026-06-02")
    ...
    def test_external_review_followup_tracker_is_actionable_and_conservative(self):
        ...
        self.assertEqual(values["platforms"]["baseScan"]["lastCheckedDate"], "2026-06-02")
