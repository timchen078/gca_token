...
class LaunchPackageTests(unittest.TestCase):
    ...
    def test_listing_readiness_page_gates_tracked_listing_submissions(self):
        ...
        self.assertIn("Tim Chen profile published; domain email and evidence packet still required", page)
        self.assertIn("Plan and evidence packet published; mailbox not active yet", page)
    ...
    def test_listing_kit_and_project_json_are_copyable(self):
        ...
        self.assertIn("project-domain email is ready; the domain email setup plan and activation evidence packet are published", kit)
    ...
    def test_listing_readiness_json_gates_tracked_listing_submissions(self):
        ...
        self.assertIn("domain email setup plan and activation evidence packet are published", checks["basescan-token-profile"]["evidence"])
        ...
        self.assertIn("Use the domain email setup plan at https://gcagochina.com/domain-email.html, then create and publish a working gcagochina.com domain email and archive the activation evidence packet before the next BaseScan submission.", readiness["nextActions"])
    ...
    def test_trust_center_page_and_json_centralize_public_verification(self):
        ...
        self.assertIn("The domain email setup plan and latest DNS snapshot are published; support@gcagochina.com is not ready for BaseScan evidence until MX/SPF/DMARC/DKIM checks pass.", trust["safePublicClaims"])
