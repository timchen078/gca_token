...
class LaunchPackageTests(unittest.TestCase):
    ...
    def test_narrative_page_and_json_define_public_narrative_system(self):
        ...
        self.assertIn("operate and monitor the live token-protected service request Worker route", narrative["buildNext"])
        self.assertIn("operate and monitor the live token-protected credit usage Worker route", narrative["buildNext"])
