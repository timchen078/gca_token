...
class LaunchPackageTests(unittest.TestCase):
    ...
    def test_community_page_and_json_define_safe_public_messaging(self):
        ...
        self.assertEqual(community["publishingDesk"]["nextPublishTargetDate"], "2026-05-20")
    ...
    def test_announcements_page_and_json_track_official_content_cadence(self):
        ...
        self.assertEqual(announcements["publishingDesk"]["nextPublishTargetDate"], "2026-05-20")
    ...
    def test_campaign_page_and_json_publish_30_day_content_calendar(self):
        ...
        self.assertEqual(campaign["nextCopyReadyDraft"]["targetDate"], "2026-05-20")
        self.assertEqual(campaign["nextCopyReadyDraft"]["recommendedLink"], RADAR_ISSUE_004_PAGE_URL)
        ...
        self.assertEqual(campaign["publishingDesk"]["nextPublishTargetDate"], "2026-05-20")
    ...
    def test_publishing_desk_page_and_json_define_manual_posting_workflow(self):
        ...
        self.assertEqual(action["targetDate"], "2026-05-20")
        self.assertEqual(action["sourceDraftId"], "gca-draft-2026-05-20-radar")
        self.assertEqual(action["topic"], "Weekly Go China Radar")
        self.assertEqual(action["channels"], ["X", "Telegram"])
        self.assertEqual(action["recommendedLink"], RADAR_ISSUE_004_PAGE_URL)
    ...
    def test_listing_kit_and_project_json_are_copyable(self):
        ...
        self.assertEqual(project["lastUpdated"], "2026-05-20")
        ...
        self.assertEqual(project["contentCampaign"]["nextDraftLink"], RADAR_ISSUE_004_PAGE_URL)
        ...
        self.assertEqual(project["publishingDesk"]["nextPublishTargetDate"], "2026-05-20")
