...
class LaunchPackageTests(unittest.TestCase):
    ...
    def test_well_known_identity_files_are_public_and_conservative(self):
        ...
        self.assertEqual(identity["platformStatus"]["baseScanTokenProfile"], "returned-information-insufficient")
    ...
    def test_public_site_discloses_current_operational_status(self):
        site = (ROOT / "site" / "index.html").read_text()
        self.assertIn("BaseScan token profile update was returned by BaseScan as information-insufficient", site)
    ...
    def test_privacy_and_terms_pages_define_pre_registration_boundaries(self):
        ...
        self.assertIn("Returned: needs more information", terms_page)
        ...
        self.assertEqual(terms["externalStatus"]["baseScanTokenProfile"], "returned-information-insufficient")
    ...
    def test_roadmap_page_and_json_define_buildout_boundaries(self):
        ...
        self.assertIn("Returned: needs more information", page)
        ...
        self.assertEqual(roadmap["externalDependencies"]["baseScanTokenProfile"], "returned-information-insufficient")
    ...
    def test_community_page_and_json_define_safe_public_messaging(self):
        ...
        self.assertTrue(any("BaseScan token profile was returned as information-insufficient" in item for item in community["safeAnnouncement"]))
    ...
    def test_verify_page_centralizes_official_identity_and_status(self):
        ...
        self.assertIn("Returned: needs more information", verify)
    ...
    def test_markets_page_is_canonical_and_conservative(self):
        ...
        self.assertIn("Needs resubmission", markets)
    ...
    def test_risk_page_centralizes_public_disclosures(self):
        ...
        self.assertIn("BaseScan token profile was returned as information-insufficient", risk)
    ...
    def test_status_page_centralizes_public_verification(self):
        ...
        self.assertIn("Returned: needs more information", status)
    ...
    def test_listing_kit_and_project_json_are_copyable(self):
        ...
        self.assertIn("returned by BaseScan as information-insufficient", kit)
        ...
        self.assertEqual(project["platformStatus"]["baseScanTokenProfile"], "returned-information-insufficient")
        ...
        self.assertEqual(project["externalReviewStatus"]["baseScanTokenProfile"], "returned-information-insufficient")
    ...
    def test_listing_readiness_json_gates_tracked_listing_submissions(self):
        ...
        self.assertEqual(checks["basescan-token-profile"]["status"], "needs-resubmission")
        self.assertIn("returned by BaseScan as information-insufficient", checks["basescan-token-profile"]["evidence"])
        ...
        self.assertIn("Prepare a complete BaseScan resubmission package.", readiness["nextActions"])
    ...
    def test_external_reviews_page_and_json_centralize_review_status(self):
        ...
        self.assertEqual(reviews["reviews"]["baseScanTokenProfile"]["status"], "returned-information-insufficient")
    ...
    def test_token_list_json_is_official_and_conservative(self):
        ...
        self.assertEqual(extensions["baseScanTokenProfileStatus"], "returned-information-insufficient")
    ...
    def test_basescan_review_followup_is_actionable(self):
        ...
        self.assertIn("returned-information-insufficient", followup)
        ...
        self.assertIn("complete resubmission", followup)
    ...
    def test_basescan_form_values_are_copyable(self):
        ...
        self.assertEqual(values["submissionStatus"], "returned")
        self.assertEqual(values["reviewStatus"], "returned-information-insufficient")
        ...
        self.assertIn("BaseScan resubmission", values["socialLinkNote"])
    ...
    def test_basescan_resubmission_package_is_complete(self):
        ...
        self.assertIn("returned by BaseScan as information-insufficient on 2026-05-13", package)
    ...
    def test_external_review_followup_tracker_is_actionable_and_conservative(self):
        ...
        self.assertIn("Submitted on 2026-05-09 and returned by BaseScan as information-insufficient on 2026-05-13", tracker)
        ...
        self.assertEqual(values["platforms"]["baseScan"]["profileStatus"], "returned-information-insufficient")
        ...
        self.assertIn("complete BaseScan resubmission package", values["platforms"]["baseScan"]["nextAction"])
