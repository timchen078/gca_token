...
class LaunchPackageTests(unittest.TestCase):
    ...
    def test_privacy_and_terms_pages_define_pre_registration_boundaries(self):
        ...
        self.assertIn("Returned 2026-05-23; ready for owner resubmission", terms_page)
    ...
    def test_roadmap_page_and_json_define_buildout_boundaries(self):
        ...
        self.assertIn("Returned 2026-05-23; ready for owner resubmission", page)
    ...
    def test_release_gates_page_and_json_define_go_live_boundaries(self):
        ...
        self.assertIn("Returned 2026-05-23; owner package ready, awaiting review", page)
    ...
    def test_verify_page_centralizes_official_identity_and_status(self):
        ...
        self.assertIn("Returned 2026-05-23; ready for owner resubmission", verify)
    ...
    def test_listing_readiness_page_gates_tracked_listing_submissions(self):
        ...
        self.assertIn("Returned again 2026-05-23; ready for one owner resubmission", page)
        self.assertIn("Tim Chen profile, domain email plan, evidence checklist, activation evidence packet, and support@gcagochina.com evidence are ready", page)
