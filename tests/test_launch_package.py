...
class LaunchPackageTests(unittest.TestCase):
    ...
    def test_community_page_and_json_define_safe_public_messaging(self):
        ...
        self.assertEqual(community["publishingDesk"]["nextPublishTargetDate"], "2026-05-23")
    ...
    def test_announcements_page_and_json_track_official_content_cadence(self):
        ...
        self.assertEqual(announcements["lastUpdated"], "2026-06-02")
        ...
        self.assertTrue(any(item["recommendedLink"] == UTILITY_PAGE_URL for item in announcements["nextContentQueue"]))
        ...
        self.assertEqual(announcements["publishingDesk"]["nextPublishTargetDate"], "2026-05-23")
    ...
    def test_campaign_page_and_json_publish_30_day_content_calendar(self):
        ...
        self.assertEqual(campaign["nextCopyReadyDraft"]["targetDate"], "2026-05-23")
        self.assertEqual(campaign["nextCopyReadyDraft"]["recommendedLink"], MEMBER_ACCESS_BRIEF_001_PAGE_URL)
        ...
        self.assertEqual(campaign["publishingDesk"]["nextPublishTargetDate"], "2026-05-23")
    ...
    def test_publishing_desk_page_and_json_define_manual_posting_workflow(self):
        ...
        self.assertEqual(action["targetDate"], "2026-05-23")
        self.assertEqual(action["sourceDraftId"], "gca-draft-2026-05-23-member-access")
        self.assertEqual(action["topic"], "GCA Member Access Brief 001")
        self.assertEqual(action["channels"], ["X", "Telegram"])
        self.assertEqual(action["recommendedLink"], MEMBER_ACCESS_BRIEF_001_PAGE_URL)
    ...
    def test_listing_kit_and_project_json_are_copyable(self):
        ...
        self.assertEqual(project["contentCampaign"]["nextDraftLink"], MEMBER_ACCESS_BRIEF_001_PAGE_URL)
        ...
        self.assertEqual(project["publishingDesk"]["nextPublishTargetDate"], "2026-05-23")
