...
class LaunchPackageTests(unittest.TestCase):
    ...
    def test_announcements_page_and_json_track_official_content_cadence(self):
        ...
        self.assertEqual(announcements["lastUpdated"], "2026-06-06")
        ...
        self.assertTrue(any(item["recommendedLink"] == SECURITY_PAGE_URL for item in announcements["nextContentQueue"]))
        self.assertTrue(any(item["recommendedLink"] == PRODUCT_PAGE_URL for item in announcements["nextContentQueue"]))
    ...
    def test_campaign_page_and_json_publish_30_day_content_calendar(self):
        ...
        self.assertEqual(campaign["lastUpdated"], "2026-06-06")
        ...
        self.assertEqual(campaign["nextCopyReadyDraft"]["recommendedLink"], SECURITY_PAGE_URL)
    ...
    def test_content_library_page_and_json_publish_bilingual_drafts(self):
        ...
        self.assertIn("Product Spec", page)
        ...
        self.assertEqual(library["lastUpdated"], "2026-06-06")
    ...
    def test_publishing_desk_page_and_json_define_manual_posting_workflow(self):
        ...
        self.assertEqual(desk["lastUpdated"], "2026-06-06")
        ...
        self.assertEqual(action["sourceDraftId"], "gca-draft-2026-06-07-security")
        self.assertEqual(action["topic"], "Security Boundary")
        self.assertEqual(action["channels"], ["X", "Telegram"])
        self.assertEqual(action["recommendedLink"], SECURITY_PAGE_URL)
    ...
    def test_listing_kit_and_project_json_are_copyable(self):
        ...
        self.assertEqual(project["contentCampaign"]["nextDraftLink"], SECURITY_PAGE_URL)
