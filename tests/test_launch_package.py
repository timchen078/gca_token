...
class LaunchPackageTests(unittest.TestCase):
    ...
    def test_well_known_identity_files_are_public_and_conservative(self):
        ...
        self.assertEqual(wallet_security["walletReviewStatus"]["blockaidMetaMaskWarning"], "submitted-warning-removal-not-confirmed")
        self.assertFalse(wallet_security["walletReviewStatus"]["warningRemovalConfirmed"])
        ...
        self.assertIn("Blockaid or MetaMask warning removal before visible confirmation", wallet_security["publicClaimBoundaries"]["doNotClaim"])
    ...
    def test_roadmap_page_and_json_define_buildout_boundaries(self):
        ...
        self.assertIn("Removal not confirmed", page)
        ...
        self.assertEqual(roadmap["externalDependencies"]["blockaidMetaMaskWarning"], "submitted-warning-removal-not-confirmed")
    ...
    def test_reviewer_kit_page_and_json_centralize_reviewer_evidence(self):
        ...
        self.assertEqual(kit["externalReviewStatus"]["blockaidMetaMask"], "submitted-warning-removal-not-confirmed")
        ...
        self.assertIn("Blockaid or MetaMask warning removal before visible confirmation", kit["publicClaimBoundaries"]["doNotClaim"])
    ...
    def test_platform_replies_page_and_json_publish_copyable_templates(self):
        ...
        self.assertIn("Warning removal is not confirmed", page)
        ...
        self.assertIn("Warning removal is not confirmed.", wallet_body)
        self.assertIn("No third-party audit has been completed.", replies["safePublicClaims"])
        self.assertIn("Blockaid or MetaMask warning removal before visible confirmation", replies["doNotClaim"])
    ...
    def test_trust_center_page_and_json_centralize_public_verification(self):
        ...
        self.assertIn(RESERVE_WALLET, page)
        self.assertIn("No completed third-party audit", page)
        self.assertIn("Submitted, removal not confirmed", page)
        self.assertIn("Wallet Security JSON", page)
        self.assertNotIn(OLD_WETH_POOL_ADDRESS, page)
        ...
        self.assertEqual(trust["verificationSnapshot"]["walletWarning"], "submitted-warning-removal-not-confirmed")
        ...
        self.assertIn("Blockaid or MetaMask warning removal before visible confirmation", trust["doNotClaim"])
