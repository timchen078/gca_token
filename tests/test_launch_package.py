...
class LaunchPackageTests(unittest.TestCase):
    ...
    def test_well_known_identity_files_are_public_and_conservative(self):
        ...
        self.assertEqual(identity["platformStatus"]["accessApiContract"], "public-access-api-contract-email-registration-live")
    ...
    def test_access_api_page_and_json_define_contract_only_backend_routes(self):
        ...
        for forbidden in (
            ...
            self.assertNotIn(forbidden, page)
        self.assertIn("email API live", page)
        self.assertIn("Email registration live", page)
        self.assertIn("not a public self-service claim page", page)
        self.assertIn("tools/gca_member_backend.py", page)
        self.assertIn("tools/export_gca_review_package.py", page)
        ...
        self.assertEqual(api["status"], "public-access-api-contract-email-registration-live")
    ...
    def test_access_operations_page_and_json_define_manual_operations_runbook(self):
        ...
        self.assertFalse(ops["currentState"]["accountAndMemberBackendLive"])
    ...
    def test_listing_kit_and_project_json_are_copyable(self):
        ...
        self.assertEqual(project["platformStatus"]["accessApiContract"], "public-access-api-contract-email-registration-live")
        ...
        self.assertEqual(project["accessApiContract"]["status"], "public-access-api-contract-email-registration-live")
        ...
        self.assertEqual(project["accessApiContract"]["currentStage"], "email-registration-api-live")
    ...
    def test_token_list_json_is_official_and_conservative(self):
        ...
        self.assertEqual(extensions["accessApiStatus"], "public-access-api-contract-email-registration-live")
