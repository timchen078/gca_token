...
class LaunchPackageTests(unittest.TestCase):
    ...
    def test_domain_email_setup_page_and_json_gate_basescan_resubmission(self):
        ...
        self.assertIn("2026-05-28 Read-Only DNS Check", page)
        ...
        self.assertEqual(data["liveDnsSnapshot"]["checkedAt"], "2026-05-28T12:41:11Z")
        ...
        self.assertEqual(snapshot_alignment_checker["canonicalSnapshot"]["checkedAt"], "2026-05-28T12:41:11Z")
        self.assertEqual(snapshot_alignment_checker["canonicalSnapshot"]["date"], "2026-05-28")
    ...
    def test_domain_email_activation_runbook_is_actionable_and_bounded(self):
        ...
        self.assertIn("Latest Read-Only DNS Snapshot (2026-05-28)", runbook)
        self.assertIn("Checked at: `2026-05-28T12:41:11Z`", runbook)
    ...
    def test_basescan_remediation_page_and_json_track_return_notice(self):
        ...
        self.assertIn("support@gcagochina.com", page)
        self.assertIn("2026-05-28 DNS snapshot", page)
        ...
        self.assertEqual(data["currentEmailState"]["latestDnsSnapshot"]["checkedAt"], "2026-05-28T12:41:11Z")
        ...
        self.assertIn(
            "Fix the 2026-05-28 DNS snapshot blockers",
            " ".join(data["nextSubmissionGate"]["requiredBeforeReady"]),
        )
        self.assertIn(
            "DNS Entry Worksheet",
    ...
    def test_status_page_centralizes_public_verification(self):
        ...
        self.assertIn("2026-05-28 DNS snapshot: MX/SPF/DMARC missing, DKIM selector required", status)
    ...
    def test_external_reviews_page_and_json_centralize_review_status(self):
        ...
        self.assertEqual(reviews["lastUpdated"], "2026-05-28")
        ...
        self.assertIn("2026-05-28 DNS snapshot", reviews["reviews"]["baseScanTokenProfile"]["lastCheckedResult"])
        ...
        self.assertIn("The BaseScan domain email evidence gate is blocked by the 2026-05-28 DNS snapshot: MX/SPF/DMARC missing and DKIM selector required.", reviews["safePublicClaims"])
    ...
    def test_reviewer_kit_page_and_json_centralize_reviewer_evidence(self):
        ...
        self.assertEqual(kit["externalReviewStatus"]["baseScanDomainEmailGate"], "blocked-by-dns-snapshot-2026-05-28")
    ...
    def test_platform_replies_page_and_json_publish_copyable_templates(self):
        ...
        self.assertIn("2026-05-28 read-only DNS snapshot shows MX/SPF/DMARC missing and DKIM selector required", page)
        ...
        self.assertIn("2026-05-28 read-only DNS snapshot shows MX/SPF/DMARC missing and DKIM selector required", basescan_body)
    ...
    def test_trust_center_page_and_json_centralize_public_verification(self):
        ...
        self.assertEqual(trust["verificationSnapshot"]["baseScanDomainEmailGate"], "blocked-by-dns-snapshot-2026-05-28")
        ...
        self.assertEqual(trust["externalReviewStatus"]["baseScanDomainEmailGate"], "blocked-by-dns-snapshot-2026-05-28")
    ...
    def test_basescan_review_followup_is_actionable(self):
        ...
        self.assertIn("2026-05-28 DNS snapshot", followup)
    ...
    def test_basescan_form_values_are_copyable(self):
        ...
        self.assertEqual(values["lastCheckedDate"], "2026-05-28")
        self.assertIn("returned the token profile update again", values["lastCheckedResult"])
        self.assertIn("2026-05-28 DNS snapshot", values["lastCheckedResult"])
    ...
    def test_basescan_resubmission_package_is_complete(self):
        ...
        self.assertIn("2026-05-28 DNS snapshot", package)
        ...
        self.assertEqual(values["lastCheckedDate"], "2026-05-28")
        self.assertIn("returned the token profile update again", values["lastCheckedResult"])
        self.assertIn("2026-05-28 read-only DNS snapshot", values["lastCheckedResult"])
    ...
    def test_launch_status_separates_done_from_external_blockers(self):
        ...
        self.assertIn("2026-05-28 DNS snapshot", status)
    ...
    def test_external_review_followup_tracker_is_actionable_and_conservative(self):
        ...
        self.assertIn("2026-05-28 DNS snapshot", tracker)
        ...
        self.assertIn("Fix the 2026-05-28 DNS snapshot blockers", tracker)
        ...
        self.assertEqual(values["platforms"]["baseScan"]["lastCheckedDate"], "2026-05-28")
        self.assertIn("2026-05-28 DNS snapshot", values["platforms"]["baseScan"]["lastCheckedResult"])
        ...
        self.assertIn("fix the 2026-05-28 DNS snapshot blockers", values["platforms"]["baseScan"]["nextAction"])
    ...
    def test_site_has_whitepaper_page(self):
        ...
        self.assertIn("2026-05-28 DNS snapshot", whitepaper)
        ...
        self.assertIn("2026-05-28 DNS snapshot", whitepaper_source)
        ...
        self.assertIn("2026-05-28 DNS snapshot", public_profile)
