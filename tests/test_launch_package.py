...
class LaunchPackageTests(unittest.TestCase):
    ...
    def test_service_delivery_playbook_publishes_operator_reviewed_workflow(self):
        ...
        self.assertEqual(playbook["routeStatus"]["latestPublicRouteCheckAt"], "2026-07-27T10:53:44Z")
        ...
        self.assertEqual(playbook["routeStatus"]["workerVersionId"], "f4606d97-0427-4b04-bebf-20d23b64ae75")
    ...
    def test_worker_routes_handoff_publishes_production_route_deploy_record(self):
        ...
        self.assertEqual(handoff["currentStatus"]["latestPublicRouteCheckAt"], "2026-07-27T10:53:44Z")
        self.assertEqual(handoff["currentStatus"]["latestAdminRouteCheckAt"], "2026-07-27T10:54:00Z")
    ...
    def test_access_api_page_and_json_define_live_member_access_routes(self):
        ...
        self.assertIn("member access, redacted device-key account status, and wallet verification", page)
        self.assertIn("tools/gca_member_backend.py", page)
        self.assertIn("tools/export_gca_review_package.py", page)
        ...
        for endpoint in api["endpoints"]:
            ...
            elif endpoint["id"] in {"email-registrations-create", "contact-suppressions-create", "access-config-read", "member-access-create", "account-status-read", "wallet-verifications"}:
    ...
    def test_access_operations_page_and_json_define_manual_operations_runbook(self):
        ...
        self.assertEqual(ops["currentState"]["memberBenefitTransferProductionVerifiedAt"], "2026-07-27T10:54:00Z")
        ...
        self.assertEqual(ops["currentState"]["memberReviewProductionVerifiedAt"], "2026-07-27T10:54:00Z")
    ...
    def test_release_gates_page_and_json_define_go_live_boundaries(self):
        ...
        self.assertIn("Public account UI, wallet verification, redacted status refresh, eligible 100-credit records, protected member decisions, observed 30-day holding-history verification, and production evidence for already-completed manual member-benefit transfers are live", page)
        self.assertIn("Live at /gca/member-access/", page)
        ...
        self.assertEqual(gates["currentState"]["memberBenefitTransferProductionVerifiedAt"], "2026-07-27T10:54:00Z")
        ...
        self.assertEqual(gates["currentState"]["latestPendingRoutePublicCheckAt"], "2026-07-27T10:53:44Z")
        self.assertEqual(gates["currentState"]["latestPendingRouteAdminCheckAt"], "2026-07-27T10:54:00Z")
        ...
        self.assertEqual(gates["currentState"]["workerVersionId"], "f4606d97-0427-4b04-bebf-20d23b64ae75")
