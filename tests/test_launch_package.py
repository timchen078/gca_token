...
class LaunchPackageTests(unittest.TestCase):
    ...
    def test_service_delivery_playbook_publishes_operator_reviewed_workflow(self):
        ...
        self.assertEqual(playbook["lastUpdated"], "2026-06-18")
    ...
    def test_worker_routes_handoff_publishes_pending_route_deploy_gates(self):
        ...
        self.assertEqual(handoff["lastUpdated"], "2026-06-18")
        ...
        self.assertEqual(handoff["currentStatus"]["workerDryRun"], "passed-2026-06-18")
        self.assertEqual(handoff["currentStatus"]["d1Visibility"], "passed-2026-06-18")
