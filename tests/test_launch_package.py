...
class LaunchPackageTests(unittest.TestCase):
    ...
    def test_daily_status_page_and_json_publish_public_ops_snapshot(self):
        ...
        self.assertIn("site/support.html", payload["baseScanPreflight"]["oldEmailFilePaths"])
    ...
    def test_domain_email_setup_page_and_json_gate_basescan_resubmission(self):
        ...
        self.assertIn("GCAgochina@outlook.com", page)
        self.assertIn("support@gcagochina.com", page)
        self.assertIn("Not active yet", page)
        self.assertIn("Required before resubmission", page)
        ...
        self.assertIn("do not update public email values until inbound, outbound, DNS, and evidence checks pass", page)
        ...
        self.assertIn("15 Critical Files Still Publish The Current Outlook Email", page)
        ...
        self.assertEqual(data["status"], "domain-email-setup-plan-published-not-active")
        ...
        self.assertEqual(data["baseScanUse"]["resubmissionReady"], False)
        ...
        self.assertEqual(data["liveDnsSnapshot"]["checkedAt"], "2026-05-30T08:13:47Z")
        self.assertFalse(data["liveDnsSnapshot"]["readyForBaseScanEmailEvidence"])
        self.assertEqual(data["liveDnsSnapshot"]["checks"]["mx"], "missing")
        self.assertEqual(data["liveDnsSnapshot"]["checks"]["spf"], "missing")
        self.assertEqual(data["liveDnsSnapshot"]["checks"]["dmarc"], "missing")
        self.assertEqual(data["liveDnsSnapshot"]["checks"]["dkim"], "selector-required")
        self.assertCountEqual(data["liveDnsSnapshot"]["missingOrBlockedChecks"], ["mx", "spf", "dmarc", "dkim"])
        ...
        self.assertEqual(owner_packet["status"], "blocked-until-mailbox-dns-and-evidence-pass")
        self.assertIn("remaining BaseScan domain-email blocker", owner_packet["purpose"])
        self.assertIn("Enable a full mailbox for support@gcagochina.com", owner_packet["stepsInOrder"][0])
        ...
        self.assertIn("GCAgochina@outlook.com", switch_builder["purpose"])
        ...
        self.assertEqual(current_switch["status"], "public-email-switch-pending")
        self.assertEqual(current_switch["filesStillUsingCurrentEmail"], 15)
        ...
        self.assertIn("site/project.json", current_switch["oldEmailFilePaths"])
        self.assertIn("launch/basescan_resubmission_package.md", current_switch["oldEmailFilePaths"])
        self.assertIn("site/reviewer-kit.json", current_switch["targetAwareButStillTracked"])
        ...
        self.assertEqual(snapshot_alignment_checker["canonicalSnapshot"]["checkedAt"], "2026-05-30T08:13:47Z")
        self.assertEqual(snapshot_alignment_checker["canonicalSnapshot"]["date"], "2026-05-30")
        self.assertFalse(snapshot_alignment_checker["canonicalSnapshot"]["readyForBaseScanEmailEvidence"])
        self.assertIn("does not print secrets", snapshot_alignment_checker["boundaries"])
        self.assertEqual(data["baseScanSubmissionPolicy"]["nextCleanSubmissionSender"], "support@gcagochina.com after activation")
        self.assertIn("activation evidence packet is archived for owner records", data["baseScanSubmissionPolicy"]["doNotResubmitBefore"])
    ...
    def test_domain_email_activation_runbook_is_actionable_and_bounded(self):
        ...
        self.assertIn("Checked at: `2026-05-30T08:13:47Z`", runbook)
        self.assertIn('["mx", "spf", "dmarc", "dkim"]', runbook)
        self.assertIn("selector-required", runbook)
        ...
        self.assertIn("any listed public/support/BaseScan file still contains `GCAgochina@outlook.com`", runbook)
    ...
    def test_basescan_remediation_page_and_json_track_return_notice(self):
        ...
        self.assertEqual(data["currentEmailState"]["latestDnsSnapshot"]["checkedAt"], "2026-05-30T08:13:47Z")
        ...
        self.assertIn(
            "Fix the 2026-05-30 DNS snapshot blockers",
            " ".join(data["nextSubmissionGate"]["requiredBeforeReady"]),
        )
        self.assertIn(
            "DNS Entry Worksheet",
    ...
    def test_basescan_preflight_page_and_json_gate_next_resubmission(self):
        ...
        self.assertEqual(data["targetDomainEmail"], "support@gcagochina.com")
        self.assertEqual(data["latestDnsSnapshot"]["checkedAt"], "2026-05-30T08:13:47Z")
    ...
    def test_basescan_handoff_page_and_json_index_resubmission_evidence(self):
        ...
        self.assertIn("GCAgochina@outlook.com", page)
        self.assertIn("readyForBaseScanResubmission", page)
        self.assertIn("Do not resubmit BaseScan yet", page)
        ...
        self.assertIn("2026-05-30: MX/SPF/DMARC missing; DKIM selector required", page)
        ...
        self.assertEqual(data["status"], "blocked-until-domain-email-evidence-and-final-preflight-pass")
        self.assertEqual(data["chainId"], 8453)
        self.assertEqual(data["contractAddress"], MAINNET_ADDRESS)
        self.assertFalse(data["baseScanProfileStatus"]["readyForBaseScanResubmission"])
        self.assertEqual(data["baseScanProfileStatus"]["targetSender"], "support@gcagochina.com")
        self.assertEqual(data["baseScanProfileStatus"]["currentActiveContact"], "GCAgochina@outlook.com")
        self.assertFalse(data["domainEmailGate"]["readyForBaseScanEmailEvidence"])
        ...
        self.assertCountEqual(data["domainEmailGate"]["missingOrBlockedChecks"], ["mx", "spf", "dmarc", "dkim"])
        ...
        self.assertIn("blocked-until-support@gcagochina.com-is-active", reason_text)
        self.assertFalse(data["boundaries"]["submitsBaseScanRequest"])
    ...
    def test_well_known_identity_files_are_public_and_conservative(self):
        ...
        self.assertEqual(identity["platformStatus"]["baseScanTokenProfile"], "remediation-required-before-next-submission")
        ...
        self.assertEqual(wallet_security["baseScanStatus"]["tokenProfile"], "remediation-required-before-next-submission")
    ...
    def test_public_site_discloses_current_operational_status(self):
        ...
        self.assertIn("Public team and Tim Chen professional profile evidence, the domain email setup plan, and the public evidence checklist are now published", site)
        self.assertIn("public evidence checklist", site)
        self.assertIn("wait for a working project-domain email", site)
    ...
    def test_privacy_and_terms_pages_define_pre_registration_boundaries(self):
        ...
        self.assertIn("Returned 2026-05-23; remediation required", terms_page)
        ...
        self.assertEqual(terms["externalStatus"]["baseScanTokenProfile"], "remediation-required-before-next-submission")
    ...
    def test_support_page_and_json_define_safe_intake(self):
        ...
        self.assertIn("GCAgochina@outlook.com", page)
        self.assertIn("Domain Email", page)
        self.assertIn("Owner action required before BaseScan resubmission", page)
    ...
    def test_roadmap_page_and_json_define_buildout_boundaries(self):
        ...
        self.assertIn("Returned 2026-05-23; remediation required", page)
        ...
        self.assertEqual(roadmap["externalDependencies"]["baseScanTokenProfile"], "remediation-required-before-next-submission")
    ...
    def test_community_page_and_json_define_safe_public_messaging(self):
        ...
        self.assertIn("Tim Chen public professional profile evidence, the domain email setup plan, and the public evidence checklist are now published", community["xLaunchPack"]["currentStatusAfterLatestPost"])
        self.assertIn("working gcagochina.com mailbox is still required", community["xLaunchPack"]["currentStatusAfterLatestPost"])
    ...
    def test_announcements_page_and_json_track_official_content_cadence(self):
        ...
        self.assertIn("Tim Chen public professional profile evidence, the domain email setup plan, and the public evidence checklist are now published", latest_post["currentStatusAfterPost"])
        self.assertIn("working gcagochina.com mailbox is still required", latest_post["currentStatusAfterPost"])
    ...
    def test_release_gates_page_and_json_define_go_live_boundaries(self):
        ...
        self.assertIn("simulation or testnet first", page)
        self.assertIn("BaseScan token profile remediation", page)
        self.assertIn("Returned 2026-05-23; owner evidence required", page)
        ...
        self.assertEqual(gates["currentState"]["baseScanTokenProfile"], "remediation-required-before-next-submission")
    ...
    def test_verify_page_centralizes_official_identity_and_status(self):
        ...
        self.assertIn("Platform Metadata", verify)
        self.assertIn("Data Room", verify)
        self.assertIn("platform-only raw metadata", verify)
        ...
        self.assertIn("Returned 2026-05-23; remediation required", verify)
        ...
        self.assertIn('href="data.html"', verify)
    ...
    def test_status_page_centralizes_public_verification(self):
        ...
        self.assertIn("Returned 2026-05-23; remediation required", status)
        self.assertIn("Tim Chen profile published, fix domain email DNS and evidence before resubmission", status)
        self.assertIn("2026-05-30 DNS snapshot: MX/SPF/DMARC missing, DKIM selector required", status)
        self.assertIn("BaseScan remediation DNS gate", status)
        self.assertIn("mailbox activation, DNS authentication, and inbound/outbound evidence before resubmission", status)
    ...
    def test_listing_readiness_page_gates_tracked_listing_submissions(self):
        ...
        self.assertIn("Returned again 2026-05-23; remediation required before next submission", page)
        self.assertIn("Tim Chen profile and domain email evidence checklist published; working mailbox still required", page)
        self.assertIn("Plan, public evidence checklist, and packet path published; mailbox not active yet", page)
        self.assertIn("Domain Email Evidence Checklist", page)
        self.assertIn("domain-email-evidence.html", page)
    ...
    def test_listing_kit_and_project_json_are_copyable(self):
        ...
        self.assertIn("project-domain email is ready; the domain email setup plan, public evidence checklist, and activation evidence packet are published", kit)
        ...
        self.assertEqual(project["baseScanHandoff"]["status"], "blocked-until-domain-email-evidence-and-final-preflight-pass")
        ...
        self.assertEqual(project["platformStatus"]["baseScanTokenProfile"], "remediation-required-before-next-submission")
        self.assertEqual(project["platformStatus"]["baseScanTokenProfileLastCheckedDate"], "2026-05-23")
        ...
        self.assertEqual(project["externalReviewStatus"]["baseScanTokenProfile"], "remediation-required-before-next-submission")
        self.assertEqual(project["externalReviewStatus"]["baseScanTokenProfileLastCheckedDate"], "2026-05-23")
    ...
    def test_listing_readiness_json_gates_tracked_listing_submissions(self):
        ...
        self.assertEqual(checks["basescan-token-profile"]["status"], "remediation-required-before-next-submission")
        self.assertEqual(checks["basescan-token-profile"]["lastCheckedDate"], "2026-05-23")
        ...
        self.assertIn("Use the domain email setup plan at https://gcagochina.com/domain-email.html and evidence checklist at https://gcagochina.com/domain-email-evidence.html, then create and publish a working gcagochina.com domain email and archive the activation evidence packet before the next BaseScan submission.", readiness["nextActions"])
    ...
    def test_external_reviews_page_and_json_centralize_review_status(self):
        ...
        self.assertIn("Returned 2026-05-23; remediation required", page)
        self.assertIn("Tim Chen profile, domain email plan, evidence checklist, activation evidence packet, and reply template published", page)
        self.assertIn(TIM_CHEN_PROFILE_PAGE_URL, page)
        ...
        self.assertIn("MX/SPF/DMARC missing", page)
        self.assertIn("DKIM selector required", page)
        self.assertIn("readyForBaseScanEmailEvidence false", page)
        ...
        self.assertEqual(reviews["reviews"]["baseScanTokenProfile"]["status"], "remediation-required-before-next-submission")
        self.assertEqual(reviews["reviews"]["baseScanTokenProfile"]["lastCheckedDate"], "2026-05-23")
        ...
        self.assertIn("readyForBaseScanEmailEvidence is false", reviews["reviews"]["baseScanTokenProfile"]["lastCheckedResult"])
        ...
        self.assertFalse(reviews["reviews"]["baseScanTokenProfile"]["domainEmailDnsReadiness"]["readyForBaseScanEmailEvidence"])
        self.assertEqual(reviews["reviews"]["baseScanTokenProfile"]["domainEmailDnsReadiness"]["checks"]["mx"], "missing")
        self.assertEqual(reviews["reviews"]["baseScanTokenProfile"]["domainEmailDnsReadiness"]["checks"]["spf"], "missing")
        self.assertEqual(reviews["reviews"]["baseScanTokenProfile"]["domainEmailDnsReadiness"]["checks"]["dmarc"], "missing")
        self.assertEqual(reviews["reviews"]["baseScanTokenProfile"]["domainEmailDnsReadiness"]["checks"]["dkim"], "selector-required")
        self.assertCountEqual(reviews["reviews"]["baseScanTokenProfile"]["domainEmailDnsReadiness"]["missingOrBlockedChecks"], ["mx", "spf", "dmarc", "dkim"])
        ...
        self.assertIn("The BaseScan domain email evidence gate is blocked by the 2026-05-30 DNS snapshot: MX/SPF/DMARC missing and DKIM selector required.", reviews["safePublicClaims"])
    ...
    def test_reviewer_kit_page_and_json_centralize_reviewer_evidence(self):
        ...
        self.assertIn("readyForBaseScanResubmission", page)
        self.assertIn("do not resubmit yet", page)
        ...
        self.assertEqual(kit["externalReviewStatus"]["baseScanTokenProfile"], "remediation-required-before-next-submission")
        self.assertEqual(kit["externalReviewStatus"]["baseScanDomainEmailGate"], "blocked-by-dns-snapshot-2026-05-30")
        self.assertEqual(kit["externalReviewStatus"]["baseScanDomainEmailTarget"], "support@gcagochina.com")
        self.assertFalse(kit["externalReviewStatus"]["baseScanDomainEmailDnsSnapshot"]["readyForBaseScanEmailEvidence"])
        ...
        self.assertEqual(kit["externalReviewStatus"]["baseScanDomainEmailDnsSnapshot"]["checks"]["mx"], "missing")
        self.assertEqual(kit["externalReviewStatus"]["baseScanDomainEmailDnsSnapshot"]["checks"]["spf"], "missing")
        self.assertEqual(kit["externalReviewStatus"]["baseScanDomainEmailDnsSnapshot"]["checks"]["dmarc"], "missing")
        self.assertEqual(kit["externalReviewStatus"]["baseScanDomainEmailDnsSnapshot"]["checks"]["dkim"], "selector-required")
        self.assertCountEqual(kit["externalReviewStatus"]["baseScanDomainEmailDnsSnapshot"]["missingOrBlockedChecks"], ["mx", "spf", "dmarc", "dkim"])
        ...
        self.assertEqual(kit["baseScanResubmissionHandoff"]["status"], "blocked-until-domain-email-evidence-and-final-preflight-pass")
        ...
        self.assertEqual(kit["baseScanResubmissionHandoff"]["currentActiveContact"], "GCAgochina@outlook.com")
        self.assertFalse(kit["baseScanResubmissionHandoff"]["readyForBaseScanResubmission"])
    ...
    def test_platform_replies_page_and_json_publish_copyable_templates(self):
        ...
        self.assertIn("a working gcagochina.com domain email remains the remaining owner-controlled blocker", page)
        ...
        self.assertIn("2026-05-30 read-only DNS snapshot shows MX/SPF/DMARC missing and DKIM selector required", page)
        self.assertIn("readyForBaseScanEmailEvidence is false", page)
        ...
        self.assertIn("a working gcagochina.com domain email remains the remaining owner-controlled blocker", basescan_body)
        ...
        self.assertIn("2026-05-30 read-only DNS snapshot shows MX/SPF/DMARC missing and DKIM selector required", basescan_body)
        self.assertIn("readyForBaseScanEmailEvidence is false", basescan_body)
    ...
    def test_trust_center_page_and_json_centralize_public_verification(self):
        ...
        self.assertEqual(trust["verificationSnapshot"]["baseScanTokenProfile"], "remediation-required-before-next-submission")
        self.assertEqual(trust["verificationSnapshot"]["baseScanDomainEmailGate"], "blocked-by-dns-snapshot-2026-05-30")
        self.assertEqual(trust["verificationSnapshot"]["baseScanDomainEmailTarget"], "support@gcagochina.com")
        self.assertFalse(trust["verificationSnapshot"]["baseScanDomainEmailDnsSnapshot"]["readyForBaseScanEmailEvidence"])
        ...
        self.assertEqual(trust["verificationSnapshot"]["baseScanDomainEmailDnsSnapshot"]["checks"]["mx"], "missing")
        self.assertEqual(trust["verificationSnapshot"]["baseScanDomainEmailDnsSnapshot"]["checks"]["spf"], "missing")
        self.assertEqual(trust["verificationSnapshot"]["baseScanDomainEmailDnsSnapshot"]["checks"]["dmarc"], "missing")
        self.assertEqual(trust["verificationSnapshot"]["baseScanDomainEmailDnsSnapshot"]["checks"]["dkim"], "selector-required")
        self.assertCountEqual(trust["verificationSnapshot"]["baseScanDomainEmailDnsSnapshot"]["missingOrBlockedChecks"], ["mx", "spf", "dmarc", "dkim"])
        ...
        self.assertEqual(trust["externalReviewStatus"]["baseScanDomainEmailGate"], "blocked-by-dns-snapshot-2026-05-30")
        ...
        self.assertIn("The domain email setup plan, public evidence checklist, and latest DNS snapshot are published; support@gcagochina.com is not ready for BaseScan evidence until MX/SPF/DMARC/DKIM checks pass.", trust["safePublicClaims"])
    ...
    def test_token_safety_page_and_json_publish_reviewer_checklist(self):
        ...
        self.assertEqual(safety["pendingOrNotClaimed"]["baseScanTokenProfile"], "remediation-required-before-next-submission")
    ...
    def test_token_list_json_is_official_and_conservative(self):
        ...
        self.assertEqual(extensions["baseScanTokenProfileStatus"], "remediation-required-before-next-submission")
    ...
    def test_basescan_review_followup_is_actionable(self):
        ...
        self.assertIn("remediation-required-before-next-submission", followup)
        ...
        self.assertIn("MX/SPF/DMARC missing", followup)
        self.assertIn("DKIM selector required", followup)
        ...
        self.assertIn("readyForBaseScanEmailEvidence is false", followup)
    ...
    def test_basescan_form_values_are_copyable(self):
        ...
        self.assertEqual(values["reviewStatus"], "remediation-required-before-next-submission")
        ...
        self.assertIn("readyForBaseScanEmailEvidence is false", values["lastCheckedResult"])
        ...
        self.assertFalse(values["domainEmailDnsReadiness"]["readyForBaseScanEmailEvidence"])
        self.assertEqual(values["domainEmailDnsReadiness"]["checks"]["mx"], "missing")
        self.assertEqual(values["domainEmailDnsReadiness"]["checks"]["spf"], "missing")
        self.assertEqual(values["domainEmailDnsReadiness"]["checks"]["dmarc"], "missing")
        self.assertEqual(values["domainEmailDnsReadiness"]["checks"]["dkim"], "selector-required")
        self.assertCountEqual(values["domainEmailDnsReadiness"]["missingOrBlockedChecks"], ["mx", "spf", "dmarc", "dkim"])
    ...
    def test_basescan_resubmission_package_is_complete(self):
        ...
        self.assertIn("Next submission ready: no", package)
        self.assertIn("2026-05-30 DNS snapshot", package)
        self.assertIn("MX/SPF/DMARC missing", package)
        self.assertIn("DKIM selector required", package)
        self.assertIn("readyForBaseScanEmailEvidence is false", package)
        ...
        self.assertEqual(values["packageStatus"], "remediation-required")
        self.assertEqual(values["returnNoticeDate"], "2026-05-13")
        self.assertEqual(values["resubmissionDate"], "2026-05-13")
        self.assertEqual(values["latestReturnNoticeDate"], "2026-05-23")
        self.assertEqual(values["lastCheckedDate"], "2026-05-30")
        ...
        self.assertEqual(values["browserSubmissionStatus"], "returned-remediation-required")
        self.assertFalse(values["nextSubmissionReady"])
        ...
        self.assertFalse(values["domainEmailActivationEvidencePacket"]["latestPublicDnsSnapshot"]["readyForBaseScanEmailEvidence"])
        self.assertEqual(values["domainEmailActivationEvidencePacket"]["latestPublicDnsSnapshot"]["checks"]["dkim"], "selector-required")
        self.assertCountEqual(values["domainEmailActivationEvidencePacket"]["latestPublicDnsSnapshot"]["missingOrBlockedChecks"], ["mx", "spf", "dmarc", "dkim"])
    ...
    def test_launch_status_separates_done_from_external_blockers(self):
        ...
        self.assertIn("MX/SPF/DMARC missing", status)
        self.assertIn("DKIM selector required", status)
    ...
    def test_x_profile_runbook_prepares_safe_first_posts(self):
        ...
        self.assertIn(DOMAIN_EMAIL_EVIDENCE_PAGE_URL, runbook)
        self.assertIn("working `gcagochina.com` mailbox still required", runbook)
    ...
    def test_external_review_followup_tracker_is_actionable_and_conservative(self):
        ...
        self.assertIn("MX/SPF/DMARC missing", tracker)
        self.assertIn("DKIM selector required", tracker)
        ...
        self.assertIn("create and test a working `gcagochina.com` domain email", tracker)
        self.assertIn("Fix the 2026-05-30 DNS snapshot blockers", tracker)
        ...
        self.assertEqual(values["platforms"]["baseScan"]["profileStatus"], "remediation-required-before-next-submission")
        ...
        self.assertIn("readyForBaseScanEmailEvidence is false", values["platforms"]["baseScan"]["lastCheckedResult"])
        ...
        self.assertFalse(values["platforms"]["baseScan"]["domainEmailDnsReadiness"]["readyForBaseScanEmailEvidence"])
        self.assertEqual(values["platforms"]["baseScan"]["domainEmailDnsReadiness"]["checks"]["mx"], "missing")
        self.assertEqual(values["platforms"]["baseScan"]["domainEmailDnsReadiness"]["checks"]["spf"], "missing")
        self.assertEqual(values["platforms"]["baseScan"]["domainEmailDnsReadiness"]["checks"]["dmarc"], "missing")
        self.assertEqual(values["platforms"]["baseScan"]["domainEmailDnsReadiness"]["checks"]["dkim"], "selector-required")
        self.assertCountEqual(values["platforms"]["baseScan"]["domainEmailDnsReadiness"]["missingOrBlockedChecks"], ["mx", "spf", "dmarc", "dkim"])
        ...
        self.assertIn("fix the 2026-05-30 DNS snapshot blockers", values["platforms"]["baseScan"]["nextAction"])
    ...
    def test_site_has_whitepaper_page(self):
        ...
        self.assertIn("MX/SPF/DMARC missing", whitepaper)
        self.assertIn("DKIM selector required", whitepaper)
        ...
        self.assertIn("MX/SPF/DMARC missing", whitepaper_source)
        self.assertIn("DKIM selector required", whitepaper_source)
        ...
        self.assertIn("MX/SPF/DMARC missing", public_profile)
        self.assertIn("DKIM selector required", public_profile)
