...
class LaunchPackageTests(unittest.TestCase):
    ...
    def test_service_delivery_playbook_publishes_operator_reviewed_workflow(self):
        ...
        self.assertIn("dry-run passed on 2026-07-20", page)
        self.assertIn("Wrangler is logged out", page)
        self.assertIn("Both prepared Worker routes returned HTTP 404", page)
        self.assertIn("Copy-Ready Public Summary", page)
        ...
        self.assertEqual(playbook["lastUpdated"], "2026-07-20")
        ...
        self.assertFalse(playbook["routeStatus"]["d1VisibilityPassed"])
        self.assertEqual(playbook["routeStatus"]["d1VisibilityStatus"], "not-verified-auth-required")
        self.assertEqual(playbook["routeStatus"]["cloudflareAuthSession"], "failed-not-logged-in")
        self.assertEqual(playbook["routeStatus"]["workerDeployPermission"], "not-verified-auth-required")
        self.assertFalse(playbook["routeStatus"]["code10000Seen"])
        self.assertEqual(playbook["routeStatus"]["latestReadinessCheckAt"], "2026-07-20T10:34:06Z")
        self.assertEqual(playbook["routeStatus"]["latestPublicRouteCheckAt"], "2026-07-20T10:33:02Z")
        self.assertEqual(playbook["routeStatus"]["pendingRouteAnonymousGetStatus"], {
            "/gca/service-requests": 404,
            "/gca/credit-usage": 404,
        })
        self.assertIn("Wrangler not logged in", playbook["routeStatus"]["blockedBy"])
    ...
    def test_worker_routes_handoff_publishes_pending_route_deploy_gates(self):
        ...
        self.assertIn("Wrangler not logged in", page)
        self.assertIn("Worker dry-run passed on 2026-07-20", page)
        self.assertIn("HTTP 404 for both prepared routes", page)
        ...
        self.assertEqual(handoff["lastUpdated"], "2026-07-20")
        ...
        self.assertEqual(handoff["currentStatus"]["latestReadinessCheckAt"], "2026-07-20T10:34:06Z")
        self.assertEqual(handoff["currentStatus"]["latestPublicRouteCheckAt"], "2026-07-20T10:33:02Z")
        self.assertEqual(handoff["currentStatus"]["workerDryRun"], "passed-2026-07-20")
        self.assertEqual(handoff["currentStatus"]["d1Visibility"], "not-verified-auth-required")
        self.assertEqual(handoff["currentStatus"]["cloudflareAuthSession"], "failed-not-logged-in")
        self.assertEqual(handoff["currentStatus"]["workerDeployPermission"], "not-verified-auth-required")
