...
class LaunchPackageTests(unittest.TestCase):
    ...
    def test_privacy_and_terms_pages_define_pre_registration_boundaries(self):
        ...
        self.assertIn("Final package 2026-06-06T11:10:54Z; daily status 2026-06-09T14:59:01Z", terms_page)
    ...
    def test_roadmap_page_and_json_define_buildout_boundaries(self):
        ...
        self.assertIn("Final package 2026-06-06T11:10:54Z; daily status 2026-06-09T14:59:01Z", page)
    ...
    def test_release_gates_page_and_json_define_go_live_boundaries(self):
        ...
        self.assertEqual(gates["lastUpdated"], "2026-06-09")
        ...
        self.assertEqual(gates["currentState"]["baseScanTokenProfileLastCheckedDate"], "2026-06-09")
        self.assertEqual(gates["currentState"]["baseScanFinalSubmissionPackageGeneratedAt"], "2026-06-06T11:10:54Z")
        self.assertEqual(gates["currentState"]["dailyStatusGeneratedAt"], "2026-06-09T14:59:01Z")
        ...
        self.assertEqual(base_scan_gate["dailyStatusGeneratedAt"], "2026-06-09T14:59:01Z")
        ...
        self.assertIn("The latest BaseScan owner submission package was generated on 2026-06-06T11:10:54Z, and the daily public status snapshot was refreshed on 2026-06-09T14:59:01Z.", gates["publicClaimBoundaries"]["safeClaims"])
    ...
    def test_verify_page_centralizes_official_identity_and_status(self):
        ...
        self.assertIn("Final package 2026-06-06T11:10:54Z; daily status 2026-06-09T14:59:01Z", verify)
    ...
    def test_listing_readiness_page_gates_tracked_listing_submissions(self):
        ...
        self.assertIn("Snapshot refreshed 2026-06-09T14:59:01Z", page)
    ...
    def test_listing_kit_and_project_json_are_copyable(self):
        ...
        self.assertEqual(project["lastUpdated"], "2026-06-09")
        ...
        self.assertEqual(project["baseScanHandoff"]["dailyStatusGeneratedAt"], "2026-06-09T14:59:01Z")
        ...
        self.assertEqual(project["platformStatus"]["baseScanTokenProfileLastCheckedDate"], "2026-06-09")
        ...
        self.assertIn("2026-06-09T14:59:01Z", project["platformStatus"]["baseScanTokenProfileLastCheckedResult"])
        ...
        self.assertEqual(project["platformStatus"]["dailyStatusGeneratedAt"], "2026-06-09T14:59:01Z")
        self.assertEqual(project["platformStatus"]["externalReviewStatusLastUpdated"], "2026-06-09")
        ...
        self.assertEqual(project["externalReviewStatus"]["lastUpdated"], "2026-06-09")
        self.assertEqual(project["externalReviewStatus"]["baseScanTokenProfile"], "ready-for-owner-resubmission")
        self.assertEqual(project["externalReviewStatus"]["baseScanTokenProfileLastCheckedDate"], "2026-06-09")
        self.assertIn("2026-06-06T11:10:54Z", project["externalReviewStatus"]["baseScanTokenProfileLastCheckedResult"])
        self.assertIn("2026-06-09T14:59:01Z", project["externalReviewStatus"]["baseScanTokenProfileLastCheckedResult"])
        ...
        self.assertEqual(project["externalReviewStatus"]["dailyStatusGeneratedAt"], "2026-06-09T14:59:01Z")
    ...
    def test_listing_readiness_json_gates_tracked_listing_submissions(self):
        ...
        self.assertEqual(readiness["lastUpdated"], "2026-06-09")
        ...
        self.assertEqual(checks["basescan-token-profile"]["lastCheckedDate"], "2026-06-09")
        self.assertEqual(checks["basescan-token-profile"]["finalSubmissionPackageGeneratedAt"], "2026-06-06T11:10:54Z")
        self.assertEqual(checks["basescan-token-profile"]["dailyStatusGeneratedAt"], "2026-06-09T14:59:01Z")
        ...
        self.assertIn("2026-06-09T14:59:01Z", checks["basescan-token-profile"]["evidence"])
    ...
    def test_external_reviews_page_and_json_centralize_review_status(self):
        ...
        self.assertIn("2026-06-06T11:10:54Z", page)
        self.assertIn("2026-06-09T14:59:01Z", page)
        self.assertIn(TIM_CHEN_PROFILE_PAGE_URL, page)
        self.assertIn("Project Profile Map", page)
        self.assertIn("project-profile.html#basescanMapTitle", page)
        ...
        self.assertEqual(reviews["lastUpdated"], "2026-06-09")
        ...
        self.assertEqual(reviews["reviews"]["baseScanTokenProfile"]["lastCheckedDate"], "2026-06-09")
        ...
        self.assertIn("2026-06-09T14:59:01Z", reviews["reviews"]["baseScanTokenProfile"]["lastCheckedResult"])
    ...
    def test_reviewer_kit_page_and_json_centralize_reviewer_evidence(self):
        ...
        self.assertIn("Latest reviewer package", page)
        self.assertIn("Final package generated 2026-06-06T11:10:54Z; daily status refreshed 2026-06-09T14:59:01Z", page)
        ...
        self.assertEqual(kit["lastUpdated"], "2026-06-09")
        self.assertEqual(kit["chainId"], 8453)
        self.assertEqual(kit["contractAddress"], MAINNET_ADDRESS)
        ...
        self.assertEqual(kit["externalReviewStatus"]["baseScanTokenProfileLastCheckedDate"], "2026-06-09")
        self.assertEqual(kit["externalReviewStatus"]["baseScanFinalSubmissionPackageGeneratedAt"], "2026-06-06T11:10:54Z")
        self.assertEqual(kit["externalReviewStatus"]["dailyStatusGeneratedAt"], "2026-06-09T14:59:01Z")
        ...
        self.assertEqual(kit["baseScanResubmissionHandoff"]["dailyStatusGeneratedAt"], "2026-06-09T14:59:01Z")
        ...
        self.assertIn("2026-06-09T14:59:01Z", " ".join(kit["reviewerUse"]["nextActions"]))
    ...
    def test_trust_center_page_and_json_centralize_public_verification(self):
        ...
        self.assertEqual(trust["lastUpdated"], "2026-06-09")
        ...
        self.assertEqual(trust["verificationSnapshot"]["baseScanTokenProfileLastCheckedDate"], "2026-06-09")
        self.assertEqual(trust["verificationSnapshot"]["baseScanFinalSubmissionPackageGeneratedAt"], "2026-06-06T11:10:54Z")
        self.assertEqual(trust["verificationSnapshot"]["dailyStatusGeneratedAt"], "2026-06-09T14:59:01Z")
        ...
        self.assertEqual(trust["externalReviewStatus"]["baseScanTokenProfileLastCheckedDate"], "2026-06-09")
        self.assertEqual(trust["externalReviewStatus"]["baseScanFinalSubmissionPackageGeneratedAt"], "2026-06-06T11:10:54Z")
        self.assertEqual(trust["externalReviewStatus"]["dailyStatusGeneratedAt"], "2026-06-09T14:59:01Z")
        ...
        self.assertIn("The latest BaseScan owner submission package was generated on 2026-06-06T11:10:54Z, and the daily public status snapshot was refreshed on 2026-06-09T14:59:01Z.", trust["safePublicClaims"])
    ...
    def test_basescan_form_values_are_copyable(self):
        ...
        self.assertEqual(values["lastCheckedDate"], "2026-06-09")
        ...
        self.assertIn("2026-06-09T14:59:01Z", values["lastCheckedResult"])
        ...
        self.assertEqual(values["dailyStatusGeneratedAt"], "2026-06-09T14:59:01Z")
    ...
    def test_external_review_followup_tracker_is_actionable_and_conservative(self):
        ...
        self.assertEqual(values["platforms"]["baseScan"]["lastCheckedDate"], "2026-06-09")
        ...
        self.assertIn("2026-06-09T14:59:01Z", values["platforms"]["baseScan"]["lastCheckedResult"])
